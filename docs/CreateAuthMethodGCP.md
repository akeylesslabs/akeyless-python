...
json = "{}"
# create an instance of CreateAuthMethodGCP from a JSON string
create_auth_method_gcp_instance = CreateAuthMethodGCP.from_json(json)
# print the JSON string representation of the object
print(CreateAuthMethodGCP.to_json())

# convert the object into a dict
create_auth_method_gcp_dict = create_auth_method_gcp_instance.to_dict()
# create an instance of CreateAuthMethodGCP from a dict
create_auth_method_gcp_from_dict = CreateAuthMethodGCP.from_dict(create_auth_method_gcp_dict)
```
