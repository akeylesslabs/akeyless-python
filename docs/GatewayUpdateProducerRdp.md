...
gateway_update_producer_rdp_instance = GatewayUpdateProducerRdp.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateProducerRdp.to_json())

# convert the object into a dict
gateway_update_producer_rdp_dict = gateway_update_producer_rdp_instance.to_dict()
# create an instance of GatewayUpdateProducerRdp from a dict
gateway_update_producer_rdp_from_dict = GatewayUpdateProducerRdp.from_dict(gateway_update_producer_rdp_dict)
```
