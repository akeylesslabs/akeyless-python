...
json = "{}"
# create an instance of RotatedSecretUpdateSsh from a JSON string
rotated_secret_update_ssh_instance = RotatedSecretUpdateSsh.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateSsh.to_json())

# convert the object into a dict
rotated_secret_update_ssh_dict = rotated_secret_update_ssh_instance.to_dict()
# create an instance of RotatedSecretUpdateSsh from a dict
rotated_secret_update_ssh_from_dict = RotatedSecretUpdateSsh.from_dict(rotated_secret_update_ssh_dict)
```
