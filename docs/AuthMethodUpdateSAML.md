...
json = "{}"
# create an instance of AuthMethodUpdateSAML from a JSON string
auth_method_update_saml_instance = AuthMethodUpdateSAML.from_json(json)
# print the JSON string representation of the object
print(AuthMethodUpdateSAML.to_json())

# convert the object into a dict
auth_method_update_saml_dict = auth_method_update_saml_instance.to_dict()
# create an instance of AuthMethodUpdateSAML from a dict
auth_method_update_saml_from_dict = AuthMethodUpdateSAML.from_dict(auth_method_update_saml_dict)
```
