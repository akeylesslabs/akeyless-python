...
json = "{}"
# create an instance of RotatedSecretCreateCassandra from a JSON string
rotated_secret_create_cassandra_instance = RotatedSecretCreateCassandra.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateCassandra.to_json())

# convert the object into a dict
rotated_secret_create_cassandra_dict = rotated_secret_create_cassandra_instance.to_dict()
# create an instance of RotatedSecretCreateCassandra from a dict
rotated_secret_create_cassandra_from_dict = RotatedSecretCreateCassandra.from_dict(rotated_secret_create_cassandra_dict)
```
