...
json = "{}"
# create an instance of RotatedSecretCreateOracledb from a JSON string
rotated_secret_create_oracledb_instance = RotatedSecretCreateOracledb.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateOracledb.to_json())

# convert the object into a dict
rotated_secret_create_oracledb_dict = rotated_secret_create_oracledb_instance.to_dict()
# create an instance of RotatedSecretCreateOracledb from a dict
rotated_secret_create_oracledb_from_dict = RotatedSecretCreateOracledb.from_dict(rotated_secret_create_oracledb_dict)
```
