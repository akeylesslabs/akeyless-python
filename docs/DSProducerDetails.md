...
**k8s_temp_role_binding_definition** | **list[int]** | Yaml/Json definition of temporary role binding that will be created and deleted when TTL is due. Must have as subject name of Service Account specified in K8sServiceAccount field | [optional] 
**k8s_temp_role_definition** | **list[int]** | Yaml/Json definition of temporary role that will be created and deleted when TTL is due | [optional] 
