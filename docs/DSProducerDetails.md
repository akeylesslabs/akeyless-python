...
**aerospike_client_certificate** | **str** |  | [optional] 
**aerospike_client_id** | **str** |  | [optional] 
**aerospike_client_private_key** | **str** |  | [optional] 
**aerospike_client_secret** | **str** |  | [optional] 
**aerospike_cloud** | **bool** |  | [optional] 
**aerospike_cluster_id** | **str** |  | [optional] 
**aerospike_db_server_name** | **str** |  | [optional] 
**aerospike_enable_mtls** | **bool** |  | [optional] 
...
**aerospike_skip_server_name_validation** | **str** |  | [optional] 
**aerospike_ssl_connection_certificate** | **str** |  | [optional] 
**aerospike_ssl_connection_mode** | **bool** |  | [optional] 
...
**azure_administrative_unit** | **str** |  | [optional] 
...
**block_parent_target_access** | **bool** |  | [optional] 
...
**gcp_access_type** | **str** |  | [optional] 
**gcp_fixed_user_claim_keyname** | **str** |  | [optional] 
**gcp_key_algo** | **str** |  | [optional] 
**gcp_project_id** | **str** |  | [optional] 
**gcp_role_bindings** | **dict(str, list[str])** |  | [optional] 
**gcp_role_names** | **str** |  | [optional] 
...
**mongodb_scopes** | **str** |  | [optional] 
**mongodb_uri_connection** | **str** | mongodb fields | [optional] 
**mongodb_uri_options** | **str** |  | [optional] 
**mongodb_username** | **str** |  | [optional] 
**mssql_allowed_db_names** | **str** | Comma-separated list of allowed DB names for runtime selection when fetching the secret value. Empty string &#x3D;&gt; use target DB name only (no override allowed) \&quot;*\&quot; &#x3D;&gt; any DB name is allowed One or more names &#x3D;&gt; user must select one of the provided names | [optional] 
...
**preserve_existing_password_settings** | **bool** | Internal marker for DS update flows: when true, keep the persisted password settings and merge explicit rule updates on top. | [optional] 
...
**sf_auth_mode** | **str** |  | [optional] 
**sf_key_algo** | **str** |  | [optional] 
...
**username_template** | **str** |  | [optional] 
