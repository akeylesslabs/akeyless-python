...
**gcp_organization_id** | **str** | GCP Organization ID (Relevant only for GCP targets) | [optional] 
**gcp_project_id** | **str** | GCP Project ID (Relevant only for GCP targets) | [optional] 
**gcp_scope** | **str** | The gcp usc scope [ project / organization / folder] | [optional] [default to 'project']
