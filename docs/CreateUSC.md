...
**gcp_folder_id** | **str** | GCP Folder ID (Relevant only for GCP targets with folder scope) | [optional] 
**gcp_organization_id** | **str** | GCP Organization ID (Relevant only for GCP targets with folder or organization scope) | [optional] 
**gcp_project_id** | **str** | GCP Project ID to manage secrets in (Relevant only for GCP targets with project scope). If empty, the project is taken from the target. | [optional] 
**gcp_scope** | **str** | The GCP USC scope [project/folder/organization]. With folder/organization, all projects under the folder/org are manageable. Relevant only for GCP targets. Defaults to project when empty. | [optional] [default to 'project']
...
**organization_name** | **str** | The organization name to create the secret in | [optional] 
...
**usc_tags** | **str** | Comma-separated list of tags to apply to all secrets created on the remote USC | [optional] 
...
**use_tags_as_filter** | **bool** | Filter the USC secret list by the value(s) of --usc-tags. [true|false] | [optional] 
