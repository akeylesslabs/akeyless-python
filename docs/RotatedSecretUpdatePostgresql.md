...
json = "{}"
# create an instance of RotatedSecretUpdatePostgresql from a JSON string
rotated_secret_update_postgresql_instance = RotatedSecretUpdatePostgresql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdatePostgresql.to_json())

# convert the object into a dict
rotated_secret_update_postgresql_dict = rotated_secret_update_postgresql_instance.to_dict()
# create an instance of RotatedSecretUpdatePostgresql from a dict
rotated_secret_update_postgresql_from_dict = RotatedSecretUpdatePostgresql.from_dict(rotated_secret_update_postgresql_dict)
```
