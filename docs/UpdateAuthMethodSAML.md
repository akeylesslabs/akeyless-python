...
json = "{}"
# create an instance of UpdateAuthMethodSAML from a JSON string
update_auth_method_saml_instance = UpdateAuthMethodSAML.from_json(json)
# print the JSON string representation of the object
print(UpdateAuthMethodSAML.to_json())

# convert the object into a dict
update_auth_method_saml_dict = update_auth_method_saml_instance.to_dict()
# create an instance of UpdateAuthMethodSAML from a dict
update_auth_method_saml_from_dict = UpdateAuthMethodSAML.from_dict(update_auth_method_saml_dict)
```
