...
json = "{}"
# create an instance of UpdateAuthMethodUniversalIdentity from a JSON string
update_auth_method_universal_identity_instance = UpdateAuthMethodUniversalIdentity.from_json(json)
# print the JSON string representation of the object
print(UpdateAuthMethodUniversalIdentity.to_json())

# convert the object into a dict
update_auth_method_universal_identity_dict = update_auth_method_universal_identity_instance.to_dict()
# create an instance of UpdateAuthMethodUniversalIdentity from a dict
update_auth_method_universal_identity_from_dict = UpdateAuthMethodUniversalIdentity.from_dict(update_auth_method_universal_identity_dict)
```
