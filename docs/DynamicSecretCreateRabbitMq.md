...
json = "{}"
# create an instance of DynamicSecretCreateRabbitMq from a JSON string
dynamic_secret_create_rabbit_mq_instance = DynamicSecretCreateRabbitMq.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateRabbitMq.to_json())

# convert the object into a dict
dynamic_secret_create_rabbit_mq_dict = dynamic_secret_create_rabbit_mq_instance.to_dict()
# create an instance of DynamicSecretCreateRabbitMq from a dict
dynamic_secret_create_rabbit_mq_from_dict = DynamicSecretCreateRabbitMq.from_dict(dynamic_secret_create_rabbit_mq_dict)
```
