...
json = "{}"
# create an instance of RotatedSecretCreateRedis from a JSON string
rotated_secret_create_redis_instance = RotatedSecretCreateRedis.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateRedis.to_json())

# convert the object into a dict
rotated_secret_create_redis_dict = rotated_secret_create_redis_instance.to_dict()
# create an instance of RotatedSecretCreateRedis from a dict
rotated_secret_create_redis_from_dict = RotatedSecretCreateRedis.from_dict(rotated_secret_create_redis_dict)
```
