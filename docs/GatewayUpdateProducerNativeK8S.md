...
gateway_update_producer_native_k8_s_instance = GatewayUpdateProducerNativeK8S.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateProducerNativeK8S.to_json())

# convert the object into a dict
gateway_update_producer_native_k8_s_dict = gateway_update_producer_native_k8_s_instance.to_dict()
# create an instance of GatewayUpdateProducerNativeK8S from a dict
gateway_update_producer_native_k8_s_from_dict = GatewayUpdateProducerNativeK8S.from_dict(gateway_update_producer_native_k8_s_dict)
```
