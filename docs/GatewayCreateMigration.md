...
json = "{}"
# create an instance of GatewayCreateMigration from a JSON string
gateway_create_migration_instance = GatewayCreateMigration.from_json(json)
# print the JSON string representation of the object
print(GatewayCreateMigration.to_json())

# convert the object into a dict
gateway_create_migration_dict = gateway_create_migration_instance.to_dict()
# create an instance of GatewayCreateMigration from a dict
gateway_create_migration_from_dict = GatewayCreateMigration.from_dict(gateway_create_migration_dict)
```
