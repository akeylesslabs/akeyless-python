...
**ad_cert_expiration_event_in** | **list[str]** | How many days before the expiration of discovered certificates would you like to be notified (Relevant only for Active Directory migration with certificate discovery enabled) | [optional] 
**ad_certificates_path_template** | **str** | Path location template for migrating certificates e.g.: /Certificates/{{COMMON_NAME}} (Relevant only for Active Directory migration with certificate discovery enabled) | [optional] 
...
**ai_certificate_discovery** | **str** | Enable AI-assisted certificate discovery (only when AI Insight is enabled on the Gateway) | [optional] 
...
**conjur_account** | **str** | Conjur account name set on your Conjur server (relevant only for Conjur migration). | [optional] 
**conjur_api_key** | **str** | Conjur API Key for the specified user (relevant only for Conjur migration). | [optional] 
...
**hashi_metadata_mode** | **str** | Controls the amount of HashiCorp Vault secret metadata migrated with each secret value. Options: none|minimal|full | [optional] 
...
**type** | **str** | Migration type (hashi/aws/gcp/k8s/azure_kv/conjur/active_directory/server_inventory/certificate) | [optional] 
**uid_token** | **str** | The universal identity token, Required only for universal_identity authentication | [optional] 
**usc_name** | **str** | Universal Secret Connector name | [optional] 
