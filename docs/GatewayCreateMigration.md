...
**hosts** | **str** | A comma separated list of IPs, CIDR ranges, or DNS names to scan | 
...
**type** | **str** | Migration type (hashi/aws/gcp/k8s/azure_kv/active_directory/server_inventory/certificate) | [optional] 
