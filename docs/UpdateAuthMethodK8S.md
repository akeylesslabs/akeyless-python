...
update_auth_method_k8_s_instance = UpdateAuthMethodK8S.from_json(json)
# print the JSON string representation of the object
print(UpdateAuthMethodK8S.to_json())

# convert the object into a dict
update_auth_method_k8_s_dict = update_auth_method_k8_s_instance.to_dict()
# create an instance of UpdateAuthMethodK8S from a dict
update_auth_method_k8_s_from_dict = UpdateAuthMethodK8S.from_dict(update_auth_method_k8_s_dict)
```
