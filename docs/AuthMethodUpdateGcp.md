...
auth_method_update_gcp_instance = AuthMethodUpdateGcp.from_json(json)
# print the JSON string representation of the object
print(AuthMethodUpdateGcp.to_json())

# convert the object into a dict
auth_method_update_gcp_dict = auth_method_update_gcp_instance.to_dict()
# create an instance of AuthMethodUpdateGcp from a dict
auth_method_update_gcp_from_dict = AuthMethodUpdateGcp.from_dict(auth_method_update_gcp_dict)
```
