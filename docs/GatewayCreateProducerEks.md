...
json = "{}"
# create an instance of GatewayCreateProducerEks from a JSON string
gateway_create_producer_eks_instance = GatewayCreateProducerEks.from_json(json)
# print the JSON string representation of the object
print(GatewayCreateProducerEks.to_json())

# convert the object into a dict
gateway_create_producer_eks_dict = gateway_create_producer_eks_instance.to_dict()
# create an instance of GatewayCreateProducerEks from a dict
gateway_create_producer_eks_from_dict = GatewayCreateProducerEks.from_dict(gateway_create_producer_eks_dict)
```
