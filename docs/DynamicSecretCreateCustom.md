...
dynamic_secret_create_custom_instance = DynamicSecretCreateCustom.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateCustom.to_json())

# convert the object into a dict
dynamic_secret_create_custom_dict = dynamic_secret_create_custom_instance.to_dict()
# create an instance of DynamicSecretCreateCustom from a dict
dynamic_secret_create_custom_from_dict = DynamicSecretCreateCustom.from_dict(dynamic_secret_create_custom_dict)
```
