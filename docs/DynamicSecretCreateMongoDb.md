...
json = "{}"
# create an instance of DynamicSecretCreateMongoDb from a JSON string
dynamic_secret_create_mongo_db_instance = DynamicSecretCreateMongoDb.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateMongoDb.to_json())

# convert the object into a dict
dynamic_secret_create_mongo_db_dict = dynamic_secret_create_mongo_db_instance.to_dict()
# create an instance of DynamicSecretCreateMongoDb from a dict
dynamic_secret_create_mongo_db_from_dict = DynamicSecretCreateMongoDb.from_dict(dynamic_secret_create_mongo_db_dict)
```
