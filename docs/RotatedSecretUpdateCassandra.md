...
rotated_secret_update_cassandra_instance = RotatedSecretUpdateCassandra.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateCassandra.to_json())

# convert the object into a dict
rotated_secret_update_cassandra_dict = rotated_secret_update_cassandra_instance.to_dict()
# create an instance of RotatedSecretUpdateCassandra from a dict
rotated_secret_update_cassandra_from_dict = RotatedSecretUpdateCassandra.from_dict(rotated_secret_update_cassandra_dict)
```
