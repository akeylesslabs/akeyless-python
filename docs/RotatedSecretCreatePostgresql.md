...
json = "{}"
# create an instance of RotatedSecretCreatePostgresql from a JSON string
rotated_secret_create_postgresql_instance = RotatedSecretCreatePostgresql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreatePostgresql.to_json())

# convert the object into a dict
rotated_secret_create_postgresql_dict = rotated_secret_create_postgresql_instance.to_dict()
# create an instance of RotatedSecretCreatePostgresql from a dict
rotated_secret_create_postgresql_from_dict = RotatedSecretCreatePostgresql.from_dict(rotated_secret_create_postgresql_dict)
```
