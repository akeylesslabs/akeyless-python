...
dynamic_secret_update_azure_instance = DynamicSecretUpdateAzure.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateAzure.to_json())

# convert the object into a dict
dynamic_secret_update_azure_dict = dynamic_secret_update_azure_instance.to_dict()
# create an instance of DynamicSecretUpdateAzure from a dict
dynamic_secret_update_azure_from_dict = DynamicSecretUpdateAzure.from_dict(dynamic_secret_update_azure_dict)
```
