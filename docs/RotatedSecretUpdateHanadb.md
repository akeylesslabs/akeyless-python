...
json = "{}"
# create an instance of RotatedSecretUpdateHanadb from a JSON string
rotated_secret_update_hanadb_instance = RotatedSecretUpdateHanadb.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateHanadb.to_json())

# convert the object into a dict
rotated_secret_update_hanadb_dict = rotated_secret_update_hanadb_instance.to_dict()
# create an instance of RotatedSecretUpdateHanadb from a dict
rotated_secret_update_hanadb_from_dict = RotatedSecretUpdateHanadb.from_dict(rotated_secret_update_hanadb_dict)
```
