...
json = "{}"
# create an instance of RotatedSecretCreateMssql from a JSON string
rotated_secret_create_mssql_instance = RotatedSecretCreateMssql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateMssql.to_json())

# convert the object into a dict
rotated_secret_create_mssql_dict = rotated_secret_create_mssql_instance.to_dict()
# create an instance of RotatedSecretCreateMssql from a dict
rotated_secret_create_mssql_from_dict = RotatedSecretCreateMssql.from_dict(rotated_secret_create_mssql_dict)
```
