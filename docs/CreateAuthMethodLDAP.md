...
create_auth_method_ldap_instance = CreateAuthMethodLDAP.from_json(json)
# print the JSON string representation of the object
print(CreateAuthMethodLDAP.to_json())

# convert the object into a dict
create_auth_method_ldap_dict = create_auth_method_ldap_instance.to_dict()
# create an instance of CreateAuthMethodLDAP from a dict
create_auth_method_ldap_from_dict = CreateAuthMethodLDAP.from_dict(create_auth_method_ldap_dict)
```
