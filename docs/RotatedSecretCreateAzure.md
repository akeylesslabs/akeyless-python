...
json = "{}"
# create an instance of RotatedSecretCreateAzure from a JSON string
rotated_secret_create_azure_instance = RotatedSecretCreateAzure.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateAzure.to_json())

# convert the object into a dict
rotated_secret_create_azure_dict = rotated_secret_create_azure_instance.to_dict()
# create an instance of RotatedSecretCreateAzure from a dict
rotated_secret_create_azure_from_dict = RotatedSecretCreateAzure.from_dict(rotated_secret_create_azure_dict)
```
