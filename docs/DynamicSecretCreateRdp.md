...
json = "{}"
# create an instance of DynamicSecretCreateRdp from a JSON string
dynamic_secret_create_rdp_instance = DynamicSecretCreateRdp.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateRdp.to_json())

# convert the object into a dict
dynamic_secret_create_rdp_dict = dynamic_secret_create_rdp_instance.to_dict()
# create an instance of DynamicSecretCreateRdp from a dict
dynamic_secret_create_rdp_from_dict = DynamicSecretCreateRdp.from_dict(dynamic_secret_create_rdp_dict)
```
