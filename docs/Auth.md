...
**access_type** | **str** | Access Type (access_key/password/saml/ldap/k8s/azure_ad/oidc/aws_iam/alicloud/universal_identity/jwt/gcp/cert/oci/kerberos) | [optional] [default to 'access_key']
...
**cloud_id** | **str** | The cloud identity (relevant only for access-type&#x3D;azure_ad,aws_iam,alicloud,gcp,oci) | [optional] 
**debug** | **bool** |  | [optional] 
