...
json = "{}"
# create an instance of UpdateAuthMethodLDAP from a JSON string
update_auth_method_ldap_instance = UpdateAuthMethodLDAP.from_json(json)
# print the JSON string representation of the object
print(UpdateAuthMethodLDAP.to_json())

# convert the object into a dict
update_auth_method_ldap_dict = update_auth_method_ldap_instance.to_dict()
# create an instance of UpdateAuthMethodLDAP from a dict
update_auth_method_ldap_from_dict = UpdateAuthMethodLDAP.from_dict(update_auth_method_ldap_dict)
```
