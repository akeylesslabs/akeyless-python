...
json = "{}"
# create an instance of DynamicSecretUpdateGke from a JSON string
dynamic_secret_update_gke_instance = DynamicSecretUpdateGke.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateGke.to_json())

# convert the object into a dict
dynamic_secret_update_gke_dict = dynamic_secret_update_gke_instance.to_dict()
# create an instance of DynamicSecretUpdateGke from a dict
dynamic_secret_update_gke_from_dict = DynamicSecretUpdateGke.from_dict(dynamic_secret_update_gke_dict)
```
