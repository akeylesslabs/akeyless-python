...
json = "{}"
# create an instance of AuthMethodCreateAzureAD from a JSON string
auth_method_create_azure_ad_instance = AuthMethodCreateAzureAD.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateAzureAD.to_json())

# convert the object into a dict
auth_method_create_azure_ad_dict = auth_method_create_azure_ad_instance.to_dict()
# create an instance of AuthMethodCreateAzureAD from a dict
auth_method_create_azure_ad_from_dict = AuthMethodCreateAzureAD.from_dict(auth_method_create_azure_ad_dict)
```
