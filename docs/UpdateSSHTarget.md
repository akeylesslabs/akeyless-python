...
json = "{}"
# create an instance of UpdateSSHTarget from a JSON string
update_ssh_target_instance = UpdateSSHTarget.from_json(json)
# print the JSON string representation of the object
print(UpdateSSHTarget.to_json())

# convert the object into a dict
update_ssh_target_dict = update_ssh_target_instance.to_dict()
# create an instance of UpdateSSHTarget from a dict
update_ssh_target_from_dict = UpdateSSHTarget.from_dict(update_ssh_target_dict)
```
