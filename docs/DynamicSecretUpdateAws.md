...
json = "{}"
# create an instance of DynamicSecretUpdateAws from a JSON string
dynamic_secret_update_aws_instance = DynamicSecretUpdateAws.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateAws.to_json())

# convert the object into a dict
dynamic_secret_update_aws_dict = dynamic_secret_update_aws_instance.to_dict()
# create an instance of DynamicSecretUpdateAws from a dict
dynamic_secret_update_aws_from_dict = DynamicSecretUpdateAws.from_dict(dynamic_secret_update_aws_dict)
```
