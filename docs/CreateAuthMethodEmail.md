...
json = "{}"
# create an instance of CreateAuthMethodEmail from a JSON string
create_auth_method_email_instance = CreateAuthMethodEmail.from_json(json)
# print the JSON string representation of the object
print(CreateAuthMethodEmail.to_json())

# convert the object into a dict
create_auth_method_email_dict = create_auth_method_email_instance.to_dict()
# create an instance of CreateAuthMethodEmail from a dict
create_auth_method_email_from_dict = CreateAuthMethodEmail.from_dict(create_auth_method_email_dict)
```
