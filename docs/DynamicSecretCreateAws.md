...
json = "{}"
# create an instance of DynamicSecretCreateAws from a JSON string
dynamic_secret_create_aws_instance = DynamicSecretCreateAws.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateAws.to_json())

# convert the object into a dict
dynamic_secret_create_aws_dict = dynamic_secret_create_aws_instance.to_dict()
# create an instance of DynamicSecretCreateAws from a dict
dynamic_secret_create_aws_from_dict = DynamicSecretCreateAws.from_dict(dynamic_secret_create_aws_dict)
```
