...
**bound_account_id** | **list[str]** | A list of AliCloud account-IDs that the access is restricted to | [optional] 
...
**sts_url** | **str** | sts URL | [optional] [default to 'https://sts.aliyuncs.com']
