...
json = "{}"
# create an instance of RotatedSecretUpdateMysql from a JSON string
rotated_secret_update_mysql_instance = RotatedSecretUpdateMysql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateMysql.to_json())

# convert the object into a dict
rotated_secret_update_mysql_dict = rotated_secret_update_mysql_instance.to_dict()
# create an instance of RotatedSecretUpdateMysql from a dict
rotated_secret_update_mysql_from_dict = RotatedSecretUpdateMysql.from_dict(rotated_secret_update_mysql_dict)
```
