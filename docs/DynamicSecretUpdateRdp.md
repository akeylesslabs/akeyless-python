...
json = "{}"
# create an instance of DynamicSecretUpdateRdp from a JSON string
dynamic_secret_update_rdp_instance = DynamicSecretUpdateRdp.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateRdp.to_json())

# convert the object into a dict
dynamic_secret_update_rdp_dict = dynamic_secret_update_rdp_instance.to_dict()
# create an instance of DynamicSecretUpdateRdp from a dict
dynamic_secret_update_rdp_from_dict = DynamicSecretUpdateRdp.from_dict(dynamic_secret_update_rdp_dict)
```
