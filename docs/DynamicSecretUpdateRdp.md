...
**block_parent_target_access** | **str** | Block access to the parent target when using a linked target [true/false]. Empty keeps the existing value on update | [optional] 
