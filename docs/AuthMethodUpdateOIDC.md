...
json = "{}"
# create an instance of AuthMethodUpdateOIDC from a JSON string
auth_method_update_oidc_instance = AuthMethodUpdateOIDC.from_json(json)
# print the JSON string representation of the object
print(AuthMethodUpdateOIDC.to_json())

# convert the object into a dict
auth_method_update_oidc_dict = auth_method_update_oidc_instance.to_dict()
# create an instance of AuthMethodUpdateOIDC from a dict
auth_method_update_oidc_from_dict = AuthMethodUpdateOIDC.from_dict(auth_method_update_oidc_dict)
```
