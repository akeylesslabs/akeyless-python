...
auth_method_update_k8s_instance = AuthMethodUpdateK8s.from_json(json)
# print the JSON string representation of the object
print(AuthMethodUpdateK8s.to_json())

# convert the object into a dict
auth_method_update_k8s_dict = auth_method_update_k8s_instance.to_dict()
# create an instance of AuthMethodUpdateK8s from a dict
auth_method_update_k8s_from_dict = AuthMethodUpdateK8s.from_dict(auth_method_update_k8s_dict)
```
