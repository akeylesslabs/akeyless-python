...
json = "{}"
# create an instance of CreateAuthMethodOIDC from a JSON string
create_auth_method_oidc_instance = CreateAuthMethodOIDC.from_json(json)
# print the JSON string representation of the object
print(CreateAuthMethodOIDC.to_json())

# convert the object into a dict
create_auth_method_oidc_dict = create_auth_method_oidc_instance.to_dict()
# create an instance of CreateAuthMethodOIDC from a dict
create_auth_method_oidc_from_dict = CreateAuthMethodOIDC.from_dict(create_auth_method_oidc_dict)
```
