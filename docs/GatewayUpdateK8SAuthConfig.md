...
gateway_update_k8_s_auth_config_instance = GatewayUpdateK8SAuthConfig.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateK8SAuthConfig.to_json())

# convert the object into a dict
gateway_update_k8_s_auth_config_dict = gateway_update_k8_s_auth_config_instance.to_dict()
# create an instance of GatewayUpdateK8SAuthConfig from a dict
gateway_update_k8_s_auth_config_from_dict = GatewayUpdateK8SAuthConfig.from_dict(gateway_update_k8_s_auth_config_dict)
```
