...
json = "{}"
# create an instance of CreateAuthMethodUniversalIdentity from a JSON string
create_auth_method_universal_identity_instance = CreateAuthMethodUniversalIdentity.from_json(json)
# print the JSON string representation of the object
print(CreateAuthMethodUniversalIdentity.to_json())

# convert the object into a dict
create_auth_method_universal_identity_dict = create_auth_method_universal_identity_instance.to_dict()
# create an instance of CreateAuthMethodUniversalIdentity from a dict
create_auth_method_universal_identity_from_dict = CreateAuthMethodUniversalIdentity.from_dict(create_auth_method_universal_identity_dict)
```
