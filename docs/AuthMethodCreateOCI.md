...
json = "{}"
# create an instance of AuthMethodCreateOCI from a JSON string
auth_method_create_oci_instance = AuthMethodCreateOCI.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateOCI.to_json())

# convert the object into a dict
auth_method_create_oci_dict = auth_method_create_oci_instance.to_dict()
# create an instance of AuthMethodCreateOCI from a dict
auth_method_create_oci_from_dict = AuthMethodCreateOCI.from_dict(auth_method_create_oci_dict)
```
