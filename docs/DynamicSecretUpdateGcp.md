...
json = "{}"
# create an instance of DynamicSecretUpdateGcp from a JSON string
dynamic_secret_update_gcp_instance = DynamicSecretUpdateGcp.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateGcp.to_json())

# convert the object into a dict
dynamic_secret_update_gcp_dict = dynamic_secret_update_gcp_instance.to_dict()
# create an instance of DynamicSecretUpdateGcp from a dict
dynamic_secret_update_gcp_from_dict = DynamicSecretUpdateGcp.from_dict(dynamic_secret_update_gcp_dict)
```
