...
json = "{}"
# create an instance of AuthMethodUpdateOauth2 from a JSON string
auth_method_update_oauth2_instance = AuthMethodUpdateOauth2.from_json(json)
# print the JSON string representation of the object
print(AuthMethodUpdateOauth2.to_json())

# convert the object into a dict
auth_method_update_oauth2_dict = auth_method_update_oauth2_instance.to_dict()
# create an instance of AuthMethodUpdateOauth2 from a dict
auth_method_update_oauth2_from_dict = AuthMethodUpdateOauth2.from_dict(auth_method_update_oauth2_dict)
```
