...
json = "{}"
# create an instance of AuthMethodCreateLdap from a JSON string
auth_method_create_ldap_instance = AuthMethodCreateLdap.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateLdap.to_json())

# convert the object into a dict
auth_method_create_ldap_dict = auth_method_create_ldap_instance.to_dict()
# create an instance of AuthMethodCreateLdap from a dict
auth_method_create_ldap_from_dict = AuthMethodCreateLdap.from_dict(auth_method_create_ldap_dict)
```
