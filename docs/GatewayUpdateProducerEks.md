...
json = "{}"
# create an instance of GatewayUpdateProducerEks from a JSON string
gateway_update_producer_eks_instance = GatewayUpdateProducerEks.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateProducerEks.to_json())

# convert the object into a dict
gateway_update_producer_eks_dict = gateway_update_producer_eks_instance.to_dict()
# create an instance of GatewayUpdateProducerEks from a dict
gateway_update_producer_eks_from_dict = GatewayUpdateProducerEks.from_dict(gateway_update_producer_eks_dict)
```
