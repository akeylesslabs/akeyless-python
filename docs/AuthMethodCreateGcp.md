...
json = "{}"
# create an instance of AuthMethodCreateGcp from a JSON string
auth_method_create_gcp_instance = AuthMethodCreateGcp.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateGcp.to_json())

# convert the object into a dict
auth_method_create_gcp_dict = auth_method_create_gcp_instance.to_dict()
# create an instance of AuthMethodCreateGcp from a dict
auth_method_create_gcp_from_dict = AuthMethodCreateGcp.from_dict(auth_method_create_gcp_dict)
```
