...
**item_locking_enabled** | **str** | Enable item locking feature [true/false] | [optional] 
...
**lock_max_ttl** | **int** | Set the maximum TTL for item/target locks in minutes | [optional] 
