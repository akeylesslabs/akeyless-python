...
rotated_secret_create_ldap_instance = RotatedSecretCreateLdap.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateLdap.to_json())

# convert the object into a dict
rotated_secret_create_ldap_dict = rotated_secret_create_ldap_instance.to_dict()
# create an instance of RotatedSecretCreateLdap from a dict
rotated_secret_create_ldap_from_dict = RotatedSecretCreateLdap.from_dict(rotated_secret_create_ldap_dict)
```
