...
json = "{}"
# create an instance of RotatedSecretCreateMysql from a JSON string
rotated_secret_create_mysql_instance = RotatedSecretCreateMysql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateMysql.to_json())

# convert the object into a dict
rotated_secret_create_mysql_dict = rotated_secret_create_mysql_instance.to_dict()
# create an instance of RotatedSecretCreateMysql from a dict
rotated_secret_create_mysql_from_dict = RotatedSecretCreateMysql.from_dict(rotated_secret_create_mysql_dict)
```
