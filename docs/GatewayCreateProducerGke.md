...
gateway_create_producer_gke_instance = GatewayCreateProducerGke.from_json(json)
# print the JSON string representation of the object
print(GatewayCreateProducerGke.to_json())

# convert the object into a dict
gateway_create_producer_gke_dict = gateway_create_producer_gke_instance.to_dict()
# create an instance of GatewayCreateProducerGke from a dict
gateway_create_producer_gke_from_dict = GatewayCreateProducerGke.from_dict(gateway_create_producer_gke_dict)
```
