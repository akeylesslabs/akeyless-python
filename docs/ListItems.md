...
**ara_only** | **bool** | Filter by items with ARA functionality enabled | [optional] [default to False]
...
**current_folder** | **bool** | List only items in the current folder (excludes subfolders) | [optional] [default to False]
