...
event_forwarder_update_service_now_instance = EventForwarderUpdateServiceNow.from_json(json)
# print the JSON string representation of the object
print(EventForwarderUpdateServiceNow.to_json())

# convert the object into a dict
event_forwarder_update_service_now_dict = event_forwarder_update_service_now_instance.to_dict()
# create an instance of EventForwarderUpdateServiceNow from a dict
event_forwarder_update_service_now_from_dict = EventForwarderUpdateServiceNow.from_dict(event_forwarder_update_service_now_dict)
```
