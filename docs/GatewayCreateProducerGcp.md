...
gateway_create_producer_gcp_instance = GatewayCreateProducerGcp.from_json(json)
# print the JSON string representation of the object
print(GatewayCreateProducerGcp.to_json())

# convert the object into a dict
gateway_create_producer_gcp_dict = gateway_create_producer_gcp_instance.to_dict()
# create an instance of GatewayCreateProducerGcp from a dict
gateway_create_producer_gcp_from_dict = GatewayCreateProducerGcp.from_dict(gateway_create_producer_gcp_dict)
```
