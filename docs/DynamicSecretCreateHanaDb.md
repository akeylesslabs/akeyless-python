...
json = "{}"
# create an instance of DynamicSecretCreateHanaDb from a JSON string
dynamic_secret_create_hana_db_instance = DynamicSecretCreateHanaDb.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateHanaDb.to_json())

# convert the object into a dict
dynamic_secret_create_hana_db_dict = dynamic_secret_create_hana_db_instance.to_dict()
# create an instance of DynamicSecretCreateHanaDb from a dict
dynamic_secret_create_hana_db_from_dict = DynamicSecretCreateHanaDb.from_dict(dynamic_secret_create_hana_db_dict)
```
