...
gateway_create_producer_ping_instance = GatewayCreateProducerPing.from_json(json)
# print the JSON string representation of the object
print(GatewayCreateProducerPing.to_json())

# convert the object into a dict
gateway_create_producer_ping_dict = gateway_create_producer_ping_instance.to_dict()
# create an instance of GatewayCreateProducerPing from a dict
gateway_create_producer_ping_from_dict = GatewayCreateProducerPing.from_dict(gateway_create_producer_ping_dict)
```
