...
dynamic_secret_create_ping_instance = DynamicSecretCreatePing.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreatePing.to_json())

# convert the object into a dict
dynamic_secret_create_ping_dict = dynamic_secret_create_ping_instance.to_dict()
# create an instance of DynamicSecretCreatePing from a dict
dynamic_secret_create_ping_from_dict = DynamicSecretCreatePing.from_dict(dynamic_secret_create_ping_dict)
```
