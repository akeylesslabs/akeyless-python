...
json = "{}"
# create an instance of GatewayUpdateProducerMSSQL from a JSON string
gateway_update_producer_mssql_instance = GatewayUpdateProducerMSSQL.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateProducerMSSQL.to_json())

# convert the object into a dict
gateway_update_producer_mssql_dict = gateway_update_producer_mssql_instance.to_dict()
# create an instance of GatewayUpdateProducerMSSQL from a dict
gateway_update_producer_mssql_from_dict = GatewayUpdateProducerMSSQL.from_dict(gateway_update_producer_mssql_dict)
```
