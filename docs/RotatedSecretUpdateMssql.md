...
json = "{}"
# create an instance of RotatedSecretUpdateMssql from a JSON string
rotated_secret_update_mssql_instance = RotatedSecretUpdateMssql.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateMssql.to_json())

# convert the object into a dict
rotated_secret_update_mssql_dict = rotated_secret_update_mssql_instance.to_dict()
# create an instance of RotatedSecretUpdateMssql from a dict
rotated_secret_update_mssql_from_dict = RotatedSecretUpdateMssql.from_dict(rotated_secret_update_mssql_dict)
```
