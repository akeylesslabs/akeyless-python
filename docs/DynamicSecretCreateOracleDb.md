...
dynamic_secret_create_oracle_db_instance = DynamicSecretCreateOracleDb.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateOracleDb.to_json())

# convert the object into a dict
dynamic_secret_create_oracle_db_dict = dynamic_secret_create_oracle_db_instance.to_dict()
# create an instance of DynamicSecretCreateOracleDb from a dict
dynamic_secret_create_oracle_db_from_dict = DynamicSecretCreateOracleDb.from_dict(dynamic_secret_create_oracle_db_dict)
```
