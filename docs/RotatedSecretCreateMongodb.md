...
json = "{}"
# create an instance of RotatedSecretCreateMongodb from a JSON string
rotated_secret_create_mongodb_instance = RotatedSecretCreateMongodb.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretCreateMongodb.to_json())

# convert the object into a dict
rotated_secret_create_mongodb_dict = rotated_secret_create_mongodb_instance.to_dict()
# create an instance of RotatedSecretCreateMongodb from a dict
rotated_secret_create_mongodb_from_dict = RotatedSecretCreateMongodb.from_dict(rotated_secret_create_mongodb_dict)
```
