...
json = "{}"
# create an instance of AuthMethodCreateOIDC from a JSON string
auth_method_create_oidc_instance = AuthMethodCreateOIDC.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateOIDC.to_json())

# convert the object into a dict
auth_method_create_oidc_dict = auth_method_create_oidc_instance.to_dict()
# create an instance of AuthMethodCreateOIDC from a dict
auth_method_create_oidc_from_dict = AuthMethodCreateOIDC.from_dict(auth_method_create_oidc_dict)
```
