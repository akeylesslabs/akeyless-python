...
json = "{}"
# create an instance of DynamicSecretCreateMsSql from a JSON string
dynamic_secret_create_ms_sql_instance = DynamicSecretCreateMsSql.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateMsSql.to_json())

# convert the object into a dict
dynamic_secret_create_ms_sql_dict = dynamic_secret_create_ms_sql_instance.to_dict()
# create an instance of DynamicSecretCreateMsSql from a dict
dynamic_secret_create_ms_sql_from_dict = DynamicSecretCreateMsSql.from_dict(dynamic_secret_create_ms_sql_dict)
```
