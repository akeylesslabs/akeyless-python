...
json = "{}"
# create an instance of DynamicSecretCreateLdap from a JSON string
dynamic_secret_create_ldap_instance = DynamicSecretCreateLdap.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretCreateLdap.to_json())

# convert the object into a dict
dynamic_secret_create_ldap_dict = dynamic_secret_create_ldap_instance.to_dict()
# create an instance of DynamicSecretCreateLdap from a dict
dynamic_secret_create_ldap_from_dict = DynamicSecretCreateLdap.from_dict(dynamic_secret_create_ldap_dict)
```
