...
gateway_update_producer_rabbit_mq_instance = GatewayUpdateProducerRabbitMQ.from_json(json)
# print the JSON string representation of the object
print(GatewayUpdateProducerRabbitMQ.to_json())

# convert the object into a dict
gateway_update_producer_rabbit_mq_dict = gateway_update_producer_rabbit_mq_instance.to_dict()
# create an instance of GatewayUpdateProducerRabbitMQ from a dict
gateway_update_producer_rabbit_mq_from_dict = GatewayUpdateProducerRabbitMQ.from_dict(gateway_update_producer_rabbit_mq_dict)
```
