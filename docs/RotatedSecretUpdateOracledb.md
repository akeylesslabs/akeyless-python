...
json = "{}"
# create an instance of RotatedSecretUpdateOracledb from a JSON string
rotated_secret_update_oracledb_instance = RotatedSecretUpdateOracledb.from_json(json)
# print the JSON string representation of the object
print(RotatedSecretUpdateOracledb.to_json())

# convert the object into a dict
rotated_secret_update_oracledb_dict = rotated_secret_update_oracledb_instance.to_dict()
# create an instance of RotatedSecretUpdateOracledb from a dict
rotated_secret_update_oracledb_from_dict = RotatedSecretUpdateOracledb.from_dict(rotated_secret_update_oracledb_dict)
```
