...
dynamic_secret_update_venafi_instance = DynamicSecretUpdateVenafi.from_json(json)
# print the JSON string representation of the object
print(DynamicSecretUpdateVenafi.to_json())

# convert the object into a dict
dynamic_secret_update_venafi_dict = dynamic_secret_update_venafi_instance.to_dict()
# create an instance of DynamicSecretUpdateVenafi from a dict
dynamic_secret_update_venafi_from_dict = DynamicSecretUpdateVenafi.from_dict(dynamic_secret_update_venafi_dict)
```
