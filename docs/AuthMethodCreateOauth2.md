...
json = "{}"
# create an instance of AuthMethodCreateOauth2 from a JSON string
auth_method_create_oauth2_instance = AuthMethodCreateOauth2.from_json(json)
# print the JSON string representation of the object
print(AuthMethodCreateOauth2.to_json())

# convert the object into a dict
auth_method_create_oauth2_dict = auth_method_create_oauth2_instance.to_dict()
# create an instance of AuthMethodCreateOauth2 from a dict
auth_method_create_oauth2_from_dict = AuthMethodCreateOauth2.from_dict(auth_method_create_oauth2_dict)
```
