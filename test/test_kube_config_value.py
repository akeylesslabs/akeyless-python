...
import akeyless
from akeyless.models.kube_config_value import KubeConfigValue  # noqa: E501
from akeyless.rest import ApiException

class TestKubeConfigValue(unittest.TestCase):
    """KubeConfigValue unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KubeConfigValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = akeyless.models.kube_config_value.KubeConfigValue()  # noqa: E501
        if include_optional :
