...
class TargetUpdateK8s(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "json", "k8s-auth-type", "k8s-client-certificate", "k8s-client-key", "k8s-cluster-ca-cert", "k8s-cluster-endpoint", "k8s-cluster-name", "k8s-cluster-token", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "use-gw-service-account"]
