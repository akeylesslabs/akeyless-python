...
class EsmGet(BaseModel):
    ...
    secret_id: StrictStr = Field(description="The secret id (or name, for AWS, Azure or K8s targets) to get from the External Secrets Manager", alias="secret-id")
    ...
    __properties: ClassVar[List[str]] = ["esm-name", "json", "secret-id", "token", "uid-token"]
