...
class ObjectVersionSettingsOutput(BaseModel):
    """
    ...
    max_versions: Optional[StrictStr] = Field(default=None, alias="max-versions")
    __properties: ClassVar[List[str]] = ["item-type", "max-versions"]
