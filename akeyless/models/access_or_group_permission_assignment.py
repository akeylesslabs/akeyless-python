...
class AccessOrGroupPermissionAssignment(BaseModel):
    """
    AccessOrGroupPermissionAssignment
    """ # noqa: E501
    access_id: Optional[StrictStr] = None
    access_type: Optional[StrictStr] = None
    assignment_name: Optional[StrictStr] = None
    assignment_type: Optional[StrictStr] = None
    group_id: Optional[StrictStr] = None
    sub_claims: Optional[Dict[str, List[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["access_id", "access_type", "assignment_name", "assignment_type", "group_id", "sub_claims"]
