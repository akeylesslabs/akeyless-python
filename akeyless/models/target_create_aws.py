...
class TargetCreateAws(BaseModel):
    """
    TargetCreateAws
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["access-key", "access-key-id", "description", "json", "key", "max-versions", "name", "region", "session-token", "token", "uid-token", "use-gw-cloud-identity"]
