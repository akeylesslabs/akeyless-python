...
class GetSecretValue(BaseModel):
    """
    GetSecretValue
    """ # noqa: E501
    ...
    names: List[StrictStr] = Field(description="Secret name")
    pretty_print: Optional[StrictBool] = Field(default=None, description="Print the secret value with json-pretty-print (not relevent to SDK)", alias="pretty-print")
    ...
    version: Optional[StrictInt] = Field(default=None, description="Secret version, if negative value N is provided the last N versions will return (maximum 20)")
    __properties: ClassVar[List[str]] = ["accessibility", "ignore-cache", "json", "names", "pretty-print", "token", "uid-token", "version"]
