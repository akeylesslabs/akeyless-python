...
class RotatedSecretUpdateAzure(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["add-tag", "api-id", "api-key", "application-id", "authentication-credentials", "auto-rotate", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password-length", "rm-tag", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-disable-concurrent-connections", "secure-access-enable", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "storage-account-key-name", "token", "uid-token", "username"]
