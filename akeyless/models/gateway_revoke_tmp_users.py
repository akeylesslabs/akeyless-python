...
class GatewayRevokeTmpUsers(object):
    ...
    def __init__(self, gateway_url=None, host=None, name=None, soft_delete=None, tmp_creds_id=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
