...
class MigrationsConfigPart(object):
    ...
    openapi_types = {
        ...
        'conjur_migrations': 'list[ConjurMigration]',
    ...
    def __init__(self, active_directory_migrations=None, aws_secrets_migrations=None, azure_kv_migrations=None, certificate_migrations=None, conjur_migrations=None, gcp_secrets_migrations=None, hashi_migrations=None, k8s_migrations=None, mock_migrations=None, one_password_migrations=None, server_inventory_migrations=None, local_vars_configuration=None):  # noqa: E501
        ...
        if conjur_migrations is not None:
            self.conjur_migrations = conjur_migrations
    ...
    @property
    def conjur_migrations(self):
        """Gets the conjur_migrations of this MigrationsConfigPart.  # noqa: E501


        :return: The conjur_migrations of this MigrationsConfigPart.  # noqa: E501
        :rtype: list[ConjurMigration]
        """
        return self._conjur_migrations

    @conjur_migrations.setter
    def conjur_migrations(self, conjur_migrations):
        """Sets the conjur_migrations of this MigrationsConfigPart.


        :param conjur_migrations: The conjur_migrations of this MigrationsConfigPart.  # noqa: E501
        :type: list[ConjurMigration]
        """

        self._conjur_migrations = conjur_migrations
