...
class TargetUpdateGcp(BaseModel):
    """
    TargetUpdateGcp
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "gcp-key", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "use-gw-cloud-identity"]
