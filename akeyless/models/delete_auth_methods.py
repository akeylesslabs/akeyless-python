...
class DeleteAuthMethods(BaseModel):
    """
    deleteAuthMethods is a command that deletes multiple auth methods from a given path.
    """ # noqa: E501
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    path: StrictStr = Field(description="Path to delete the auth methods from")
    ...
    __properties: ClassVar[List[str]] = ["json", "path", "token", "uid-token"]
