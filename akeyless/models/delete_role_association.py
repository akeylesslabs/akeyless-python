...
class DeleteRoleAssociation(BaseModel):
    """
    deleteRoleAssociation is a command that deletes an association between role and auth method.
    """ # noqa: E501
    assoc_id: StrictStr = Field(description="The association id to be deleted", alias="assoc-id")
    ...
    __properties: ClassVar[List[str]] = ["assoc-id", "json", "token", "uid-token"]
