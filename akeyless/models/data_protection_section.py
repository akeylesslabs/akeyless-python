...
class DataProtectionSection(BaseModel):
    ...
    """ # noqa: E501
    enable_classic_key_protection: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["enable_classic_key_protection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enable_classic_key_protection": obj.get("enable_classic_key_protection")
        })
        return _obj
