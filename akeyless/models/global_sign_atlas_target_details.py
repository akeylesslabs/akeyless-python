...
class GlobalSignAtlasTargetDetails(BaseModel):
    """
    GlobalSignAtlasTargetDetails
    """ # noqa: E501
    api_key: Optional[StrictStr] = None
    api_secret: Optional[StrictStr] = None
    mtls_cert: Optional[StrictStr] = None
    mtls_key: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["api_key", "api_secret", "mtls_cert", "mtls_key", "timeout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mtls_cert": obj.get("mtls_cert"),
            "mtls_key": obj.get("mtls_key"),
