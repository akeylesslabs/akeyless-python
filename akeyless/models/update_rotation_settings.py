...
class UpdateRotationSettings(BaseModel):
    """
    updateRotationSettings is a command that updates rotations settings of an existing key
    """ # noqa: E501
    auto_rotate: StrictBool = Field(description="Whether to automatically rotate every --rotation-interval days, or disable existing automatic rotation", alias="auto-rotate")
    ...
    rotation_interval: Optional[StrictInt] = Field(default=None, description="The number of days to wait between every automatic key rotation (7-365)", alias="rotation-interval")
    ...
    __properties: ClassVar[List[str]] = ["auto-rotate", "json", "name", "rotation-event-in", "rotation-interval", "token", "uid-token"]
