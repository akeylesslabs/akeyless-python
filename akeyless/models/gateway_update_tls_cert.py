...
class GatewayUpdateTlsCert(BaseModel):
    """
    gatewayUpdateTlsCert is a command that updates Gateway TLS certificate
    """ # noqa: E501
    cert_data: Optional[StrictStr] = Field(default=None, description="TLS Certificate (base64 encoded)", alias="cert-data")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    key_data: Optional[StrictStr] = Field(default=None, description="TLS Private Key (base64 encoded)", alias="key-data")
    ...
    __properties: ClassVar[List[str]] = ["cert-data", "json", "key-data", "token", "uid-token"]
