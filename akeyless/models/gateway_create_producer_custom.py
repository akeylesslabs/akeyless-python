...
class GatewayCreateProducerCustom(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["admin-rotation-interval-days", "create-sync-url", "delete_protection", "enable-admin-rotation", "json", "name", "payload", "producer-encryption-key-name", "revoke-sync-url", "rotate-sync-url", "tags", "timeout-sec", "token", "uid-token", "user-ttl"]
