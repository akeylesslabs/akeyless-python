...
class AuthMethodCreateOCI(BaseModel):
    """
    ...
    group_ocid: List[StrictStr] = Field(description="A list of required groups ocids", alias="group-ocid")
    ...
    tenant_ocid: StrictStr = Field(description="The Oracle Cloud tenant ID", alias="tenant-ocid")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "group-ocid", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "tenant-ocid", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenant-ocid": obj.get("tenant-ocid"),
            "token": obj.get("token"),
