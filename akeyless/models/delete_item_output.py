...
class DeleteItemOutput(BaseModel):
    ...
    version_deleted: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["deletion_date", "item_id", "item_name", "version_deleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version_deleted": obj.get("version_deleted")
        })
        return _obj
