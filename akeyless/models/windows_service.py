...
class WindowsService(BaseModel):
    ...
    WindowsService
    """ # noqa: E501
    attributes: Optional[WindowsServiceAttributes] = None
    host: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attributes", "host", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": WindowsServiceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "host": obj.get("host"),
            "name": obj.get("name")
        })
        return _obj
