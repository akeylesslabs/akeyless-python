...
class KubeconfigUserExec(BaseModel):
    """
    KubeconfigUserExec
    """ # noqa: E501
    var_exec: Optional[KubeconfigExec] = Field(default=None, alias="exec")
    __properties: ClassVar[List[str]] = ["exec"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exec": KubeconfigExec.from_dict(obj["exec"]) if obj.get("exec") is not None else None
        })
        return _obj
