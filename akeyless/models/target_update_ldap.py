...
class TargetUpdateLdap(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bind-dn", "bind-dn-password", "description", "json", "keep-prev-version", "key", "ldap-ca-cert", "ldap-url", "max-versions", "name", "new-name", "server-type", "token", "token-expiration", "uid-token"]
