...
class TargetUpdateRabbitMq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "rabbitmq-server-password", "rabbitmq-server-uri", "rabbitmq-server-user", "token", "uid-token"]
