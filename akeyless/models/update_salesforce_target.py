...
class UpdateSalesforceTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["app-private-key-data", "auth-flow", "ca-cert-data", "ca-cert-name", "client-id", "client-secret", "comment", "description", "email", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "security-token", "tenant-url", "token", "uid-token", "update-version"]
