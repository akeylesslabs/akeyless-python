...
class TargetCreateGithub(BaseModel):
    """
    TargetCreateGithub
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "github-app-id", "github-app-private-key", "github-base-url", "json", "key", "max-versions", "name", "token", "uid-token"]
