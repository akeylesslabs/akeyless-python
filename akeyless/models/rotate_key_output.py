...
class RotateKeyOutput(BaseModel):
    """
    RotateKeyOutput defines output of RotateKey operation
    """ # noqa: E501
    classic_key_gw_url: Optional[StrictStr] = None
    item_type: Optional[StrictStr] = None
    new_item_version: Optional[StrictInt] = None
    next_rotation_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["classic_key_gw_url", "item_type", "new_item_version", "next_rotation_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classic_key_gw_url": obj.get("classic_key_gw_url"),
            "item_type": obj.get("item_type"),
            "new_item_version": obj.get("new_item_version"),
