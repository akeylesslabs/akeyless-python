...
class UpdatePingTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["administrative-port", "authorization-port", "comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "ping-url", "privileged-user", "token", "uid-token", "update-version"]
