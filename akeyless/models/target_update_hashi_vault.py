...
class TargetUpdateHashiVault(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "hashi-url", "json", "keep-prev-version", "key", "max-versions", "name", "namespace", "new-name", "token", "uid-token", "vault-token"]
