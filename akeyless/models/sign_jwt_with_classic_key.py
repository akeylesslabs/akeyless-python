...
class SignJWTWithClassicKey(BaseModel):
    """
    SignJWTWithClassicKey
    """ # noqa: E501
    display_id: StrictStr = Field(description="The name of the key to use in the sign JWT process", alias="display-id")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    jwt_claims: StrictStr = Field(description="JWTClaims", alias="jwt-claims")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "json", "jwt-claims", "signing-method", "token", "uid-token", "version"]
