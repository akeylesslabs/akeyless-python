...
class TargetUpdateGlobalSign(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contact-email", "contact-first-name", "contact-last-name", "contact-phone", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "profile-id", "timeout", "token", "uid-token", "username"]
