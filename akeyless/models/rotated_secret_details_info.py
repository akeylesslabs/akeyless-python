...
class RotatedSecretDetailsInfo(object):
    ...
    def __init__(self, delete_previous_version_in_days=None, grace_rotation=None, gw_cluster_id=None, last_rotation_error=None, managed_by_akeyless=None, max_versions=None, number_of_versions_to_save=None, rotation_hour=None, rotation_interval_min=None, rotation_statement=None, rotator_creds_type=None, rotator_status=None, rotator_type=None, same_password=None, services_details=None, timeout_seconds=None, local_vars_configuration=None):  # noqa: E501
