...
class CreateRabbitMQTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "json", "key", "max-versions", "name", "rabbitmq-server-password", "rabbitmq-server-uri", "rabbitmq-server-user", "token", "uid-token"]
