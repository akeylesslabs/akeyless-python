...
class APIKeyAccessRules(BaseModel):
    """
    APIKeyAccessRules
    """ # noqa: E501
    alg: Optional[StrictStr] = None
    key: Optional[StrictStr] = Field(default=None, description="The public key value of the API-key.")
    modification_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["alg", "key", "modification_date"]
