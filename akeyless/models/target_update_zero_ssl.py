...
class TargetUpdateZeroSSL(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api-key", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "timeout", "token", "uid-token"]
