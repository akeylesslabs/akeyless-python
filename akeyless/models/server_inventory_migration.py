...
class ServerInventoryMigration(BaseModel):
    """
    ServerInventoryMigration
    """ # noqa: E501
    general: Optional[MigrationGeneral] = None
    payload: Optional[ServerInventoryPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": ServerInventoryPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
