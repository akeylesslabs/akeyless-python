...
class CreateGithubTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "github-app-id", "github-app-private-key", "github-base-url", "json", "key", "max-versions", "name", "token", "uid-token"]
