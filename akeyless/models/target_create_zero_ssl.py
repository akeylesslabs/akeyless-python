...
class TargetCreateZeroSSL(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api-key", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "key", "max-versions", "name", "timeout", "token", "uid-token"]
