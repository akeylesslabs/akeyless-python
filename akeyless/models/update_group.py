...
class UpdateGroup(BaseModel):
    ...
    group_alias: StrictStr = Field(description="A short group alias", alias="group-alias")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    name: StrictStr = Field(description="Group name")
    new_name: Optional[StrictStr] = Field(default=None, description="Group new name", alias="new-name")
    ...
    user_assignment: Optional[StrictStr] = Field(default=None, description="A json string defining the access permission assignment for this client", alias="user-assignment")
    __properties: ClassVar[List[str]] = ["description", "group-alias", "json", "name", "new-name", "token", "uid-token", "user-assignment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group-alias": obj.get("group-alias"),
            "json": obj.get("json") if obj.get("json") is not None else False,
            "name": obj.get("name"),
            "new-name": obj.get("new-name"),
            "token": obj.get("token"),
            "uid-token": obj.get("uid-token"),
            "user-assignment": obj.get("user-assignment")
        })
        return _obj
