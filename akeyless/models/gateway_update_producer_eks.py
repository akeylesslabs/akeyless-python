...
class GatewayUpdateProducerEks(BaseModel):
    """
    ...
    eks_access_key_id: Optional[StrictStr] = Field(default=None, description="Access Key ID", alias="eks-access-key-id")
    eks_assume_role: Optional[StrictStr] = Field(default=None, description="IAM assume role", alias="eks-assume-role")
    eks_cluster_ca_cert: Optional[StrictStr] = Field(default=None, description="EKS cluster CA certificate", alias="eks-cluster-ca-cert")
    eks_cluster_endpoint: Optional[StrictStr] = Field(default=None, description="EKS cluster URL endpoint", alias="eks-cluster-endpoint")
    eks_cluster_name: Optional[StrictStr] = Field(default=None, description="EKS cluster name", alias="eks-cluster-name")
    eks_region: Optional[StrictStr] = Field(default='us-east-2', description="Region", alias="eks-region")
    eks_secret_access_key: Optional[StrictStr] = Field(default=None, description="Secret Access Key", alias="eks-secret-access-key")
    ...
    user_ttl: Optional[StrictStr] = Field(default='15m', description="User TTL", alias="user-ttl")
    __properties: ClassVar[List[str]] = ["delete_protection", "eks-access-key-id", "eks-assume-role", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "name", "new-name", "producer-encryption-key-name", "secure-access-allow-port-forwading", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-cluster-endpoint", "secure-access-delay", "secure-access-enable", "secure-access-web", "tags", "target-name", "token", "uid-token", "user-ttl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eks-access-key-id": obj.get("eks-access-key-id"),
            "eks-assume-role": obj.get("eks-assume-role"),
            "eks-cluster-ca-cert": obj.get("eks-cluster-ca-cert"),
            "eks-cluster-endpoint": obj.get("eks-cluster-endpoint"),
            "eks-cluster-name": obj.get("eks-cluster-name"),
            "eks-region": obj.get("eks-region") if obj.get("eks-region") is not None else 'us-east-2',
            "eks-secret-access-key": obj.get("eks-secret-access-key"),
            ...
            "user-ttl": obj.get("user-ttl") if obj.get("user-ttl") is not None else '15m'
        })
        return _obj
