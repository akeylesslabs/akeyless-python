...
class EncryptGPG(BaseModel):
    ...
    input_format: Optional[StrictStr] = Field(default=None, description="If specified, the plaintext input is assumed to be formatted accordingly. Current supported options: [base64]", alias="input-format")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "input-format", "item-id", "json", "key-name", "plaintext", "token", "uid-token"]
