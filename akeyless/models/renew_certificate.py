...
class RenewCertificate(BaseModel):
    ...
    RenewCertificate
    """ # noqa: E501
    cert_issuer_name: Optional[StrictStr] = Field(default=None, description="The name of the PKI certificate issuer", alias="cert-issuer-name")
    generate_key: Optional[StrictBool] = Field(default=None, description="Generate a new key as part of the certificate renewal", alias="generate-key")
    item_id: Optional[StrictInt] = Field(default=None, description="Certificate item id", alias="item-id")
    ...
    __properties: ClassVar[List[str]] = ["cert-issuer-name", "generate-key", "item-id", "json", "name", "token", "uid-token"]
