...
class UpdateAWSTargetDetails(BaseModel):
    """
    UpdateAWSTargetDetails
    """ # noqa: E501
    access_key: Optional[StrictStr] = Field(default=None, description="The aws secret access key", alias="access-key")
    access_key_id: Optional[StrictStr] = Field(default=None, description="The aws access key id", alias="access-key-id")
    ...
    region: Optional[StrictStr] = Field(default='us-east-2', description="The aws region")
    session_token: Optional[StrictStr] = Field(default=None, description="Required only for temporary security credentials retrieved via STS, otherwise it can be an empty string", alias="session-token")
    ...
    __properties: ClassVar[List[str]] = ["access-key", "access-key-id", "json", "keep-prev-version", "name", "new-version", "protection_key", "region", "session-token", "token", "uid-token"]
