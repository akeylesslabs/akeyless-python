...
class RotatedSecretCreateDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authentication-credentials", "auto-rotate", "delete_protection", "description", "json", "key", "max-versions", "name", "password-length", "rotation-event-in", "rotation-hour", "rotation-interval", "tags", "target-name", "token", "uid-token"]
