...
class EventForwarderCreateServiceNow(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["admin-name", "admin-pwd", "app-private-key-base64", "auth-methods-event-source-locations", "auth-type", "client-id", "client-secret", "description", "event-types", "every", "gateways-event-source-locations", "host", "items-event-source-locations", "json", "key", "name", "runner-type", "targets-event-source-locations", "token", "uid-token", "user-email"]
