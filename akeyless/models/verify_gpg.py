...
class VerifyGPG(BaseModel):
    ...
    signature: StrictStr = Field(description="The signature to be verified in base64 format")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "item-id", "json", "key-name", "passphrase", "signature", "token", "uid-token"]
