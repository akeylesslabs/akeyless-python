...
class TargetUpdateAzure(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client-id", "client-secret", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "resource-group-name", "resource-name", "subscription-id", "tenant-id", "token", "uid-token", "use-gw-cloud-identity"]
