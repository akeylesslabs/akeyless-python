...
class CreateLdapTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bind-dn", "bind-dn-password", "comment", "description", "json", "key", "ldap-ca-cert", "ldap-url", "max-versions", "name", "server-type", "token", "token-expiration", "uid-token"]
