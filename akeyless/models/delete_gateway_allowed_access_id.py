...
class DeleteGatewayAllowedAccessId(BaseModel):
    """
    deleteGatewayAllowedAccessId is a command that deletes access-id
    """ # noqa: E501
    access_id: StrictStr = Field(description="The access id to be stripped of access to gateway", alias="access-id")
    ...
    __properties: ClassVar[List[str]] = ["access-id", "cluster-name", "json", "token", "uid-token"]
