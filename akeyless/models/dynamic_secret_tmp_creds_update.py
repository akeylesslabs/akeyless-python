...
class DynamicSecretTmpCredsUpdate(BaseModel):
    """
    ...
    new_ttl_min: StrictInt = Field(description="New TTL in Minutes", alias="new-ttl-min")
    tmp_creds_id: StrictStr = Field(description="Tmp Creds ID", alias="tmp-creds-id")
    ...
    __properties: ClassVar[List[str]] = ["host", "json", "name", "new-ttl-min", "tmp-creds-id", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "new-ttl-min": obj.get("new-ttl-min"),
