...
class RequestAccess(BaseModel):
    ...
    RequestAccess
    """ # noqa: E501
    capability: List[StrictStr] = Field(description="List of the required capabilities options: [read, update, delete]")
    ...
    __properties: ClassVar[List[str]] = ["capability", "comment", "description", "json", "name", "token", "type", "uid-token"]
