...
class GetKubeExecCredsOutput(BaseModel):
    """
    GetKubeExecCredsOutput
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, alias="apiVersion")
    kind: Optional[StrictStr] = None
    status: Optional[ClientData] = None
    __properties: ClassVar[List[str]] = ["apiVersion", "kind", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "status": ClientData.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
