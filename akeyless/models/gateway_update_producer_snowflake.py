...
class GatewayUpdateProducerSnowflake(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["account", "account-password", "account-username", "db-name", "delete_protection", "json", "name", "new-name", "password-length", "private-key", "private-key-passphrase", "role", "tags", "target-name", "token", "uid-token", "user-ttl", "warehouse"]
