...
class UpdateWebTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "url"]
