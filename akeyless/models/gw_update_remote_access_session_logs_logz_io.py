...
class GwUpdateRemoteAccessSessionLogsLogzIo(BaseModel):
    """
    ...
    logz_io_token: Optional[StrictStr] = Field(default=None, description="Logz-io token", alias="logz-io-token")
    output_format: Optional[StrictStr] = Field(default='text', description="Logs format [text/json]", alias="output-format")
    protocol: Optional[StrictStr] = Field(default=None, description="LogzIo protocol [tcp/https]")
    ...
    __properties: ClassVar[List[str]] = ["enable", "json", "logz-io-token", "output-format", "protocol", "pull-interval", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logz-io-token": obj.get("logz-io-token"),
