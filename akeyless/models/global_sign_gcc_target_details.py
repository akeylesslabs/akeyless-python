...
class GlobalSignGCCTargetDetails(BaseModel):
    """
    GlobalSignGCCTargetDetails
    """ # noqa: E501
    email: Optional[StrictStr] = None
    first_name: Optional[StrictStr] = Field(default=None, description="Contact Info - GlobalSign requires this to be sent with every certificate creation request")
    ...
    __properties: ClassVar[List[str]] = ["email", "first_name", "last_name", "password", "phone", "profile_id", "timeout", "username"]
