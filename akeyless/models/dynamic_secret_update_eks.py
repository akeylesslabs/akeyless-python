...
class DynamicSecretUpdateEks(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "description", "eks-access-key-id", "eks-assume-role", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "name", "new-name", "producer-encryption-key-name", "secure-access-allow-port-forwading", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-cluster-endpoint", "secure-access-delay", "secure-access-enable", "secure-access-web", "tags", "target-name", "token", "uid-token", "user-ttl"]
