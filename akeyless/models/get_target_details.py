...
class GetTargetDetails(BaseModel):
    """
    ...
    show_versions: Optional[StrictBool] = Field(default=False, description="Include all target versions in reply", alias="show-versions")
    target_version: Optional[StrictInt] = Field(default=None, description="Target version", alias="target-version")
    ...
    __properties: ClassVar[List[str]] = ["json", "name", "show-versions", "target-version", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target-version": obj.get("target-version"),
            "token": obj.get("token"),
