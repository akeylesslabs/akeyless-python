...
class DynamicSecretUpdateCustom(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["admin-rotation-interval-days", "create-sync-url", "delete_protection", "description", "enable-admin-rotation", "json", "name", "new-name", "payload", "producer-encryption-key-name", "revoke-sync-url", "rotate-sync-url", "tags", "timeout-sec", "token", "uid-token", "user-ttl"]
