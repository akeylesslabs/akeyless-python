...
class VerifyPKICertWithClassicKey(BaseModel):
    """
    VerifyPKICertWithClassicKey
    """ # noqa: E501
    display_id: StrictStr = Field(description="The name of the key to use in the verify PKICert process", alias="display-id")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    pki_cert: StrictStr = Field(description="PkiCert", alias="pki-cert")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "json", "pki-cert", "token", "uid-token", "version"]
