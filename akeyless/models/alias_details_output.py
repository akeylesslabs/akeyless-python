...
class AliasDetailsOutput(BaseModel):
    """
    AliasDetailsOutput
    """ # noqa: E501
    access_type: Optional[StrictStr] = None
    tenant_tag: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["access_type", "tenant_tag"]
