...
class AuthMethodCreateOauth2(object):
    ...
    def allowed_client_type(self):
        """Gets the allowed_client_type of this AuthMethodCreateOauth2.  # noqa: E501

        limit the auth method usage for specific client types [cli,ui,gateway-admin,sdk,mobile,extension]  # noqa: E501

        :return: The allowed_client_type of this AuthMethodCreateOauth2.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_client_type(self, allowed_client_type):
        """Sets the allowed_client_type of this AuthMethodCreateOauth2.

        limit the auth method usage for specific client types [cli,ui,gateway-admin,sdk,mobile,extension]  # noqa: E501

        :param allowed_client_type: The allowed_client_type of this AuthMethodCreateOauth2.  # noqa: E501
        :type: list[str]
        """
