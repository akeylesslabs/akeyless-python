...
class RoleAuthMethodAssociation(BaseModel):
    """
    ...
    sub_claims_case_sensitive: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["assoc_id", "auth_method_access_id", "auth_method_name", "auth_method_sub_claims", "is_subclaims_with_operator", "sub_claims_case_sensitive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sub_claims_case_sensitive": obj.get("sub_claims_case_sensitive")
        })
        return _obj
