...
class CreateArtifactoryTarget(BaseModel):
    """
    ...
    key: Optional[StrictStr] = Field(default=None, description="The name of a key used to encrypt the target secret value (if empty, the account default protectionKey key will be used)")
    ...
    __properties: ClassVar[List[str]] = ["artifactory-admin-name", "artifactory-admin-pwd", "base-url", "comment", "description", "json", "key", "max-versions", "name", "token", "uid-token"]
