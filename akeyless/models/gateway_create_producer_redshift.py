...
class GatewayCreateProducerRedshift(object):
    ...
    def ara_enabled(self):
        """Gets the ara_enabled of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The ara_enabled of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: bool
        """
    ...
    def ara_enabled(self, ara_enabled):
        """Sets the ara_enabled of this GatewayCreateProducerRedshift.

        Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.  # noqa: E501

        :param ara_enabled: The ara_enabled of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: bool
        """
    ...
    def custom_username_template(self):
        """Gets the custom_username_template of this GatewayCreateProducerRedshift.  # noqa: E501

        Customize how temporary usernames are generated using go template  # noqa: E501

        :return: The custom_username_template of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_username_template(self, custom_username_template):
        """Sets the custom_username_template of this GatewayCreateProducerRedshift.

        Customize how temporary usernames are generated using go template  # noqa: E501

        :param custom_username_template: The custom_username_template of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: str
        """
    ...
    def enable_agentic_runtime_authority(self):
        """Gets the enable_agentic_runtime_authority of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The enable_agentic_runtime_authority of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_agentic_runtime_authority(self, enable_agentic_runtime_authority):
        """Sets the enable_agentic_runtime_authority of this GatewayCreateProducerRedshift.

        EnableAra is the documented spelling of AraEnabled; --ara-enabled shipped first and stays as an undocumented alias.  # noqa: E501

        :param enable_agentic_runtime_authority: The enable_agentic_runtime_authority of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: bool
        """
    ...
    def enable_ai_quorum(self):
        """Gets the enable_ai_quorum of this GatewayCreateProducerRedshift.  # noqa: E501

        Turns on AI Quorum checks for this item.  # noqa: E501

        :return: The enable_ai_quorum of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_ai_quorum(self, enable_ai_quorum):
        """Sets the enable_ai_quorum of this GatewayCreateProducerRedshift.

        Turns on AI Quorum checks for this item.  # noqa: E501

        :param enable_ai_quorum: The enable_ai_quorum of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The input_rule of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this GatewayCreateProducerRedshift.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).  # noqa: E501

        :param input_rule: The input_rule of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: list[str]
        """
    ...
    def item_custom_fields(self):
        """Gets the item_custom_fields of this GatewayCreateProducerRedshift.  # noqa: E501

        Additional custom fields to associate with the item  # noqa: E501

        :return: The item_custom_fields of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def item_custom_fields(self, item_custom_fields):
        """Sets the item_custom_fields of this GatewayCreateProducerRedshift.

        Additional custom fields to associate with the item  # noqa: E501

        :param item_custom_fields: The item_custom_fields of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this GatewayCreateProducerRedshift.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this GatewayCreateProducerRedshift.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: list[str]
        """
    ...
    def use_capital_letters(self):
        """Gets the use_capital_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The use_capital_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: str
        """
    ...
    def use_capital_letters(self, use_capital_letters):
        """Sets the use_capital_letters of this GatewayCreateProducerRedshift.

        Specifies whether the generated temporary password must contain at least one uppercase character from the ISO basic Latin alphabet (A to Z). [true/false]  # noqa: E501

        :param use_capital_letters: The use_capital_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: str
        """
    ...
    def use_lower_letters(self):
        """Gets the use_lower_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The use_lower_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: str
        """
    ...
    def use_lower_letters(self, use_lower_letters):
        """Sets the use_lower_letters of this GatewayCreateProducerRedshift.

        Specifies whether the generated temporary password must contain at least one lowercase character from the ISO basic Latin alphabet (a to z). [true/false]  # noqa: E501

        :param use_lower_letters: The use_lower_letters of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: str
        """
    ...
    def use_numbers(self):
        """Gets the use_numbers of this GatewayCreateProducerRedshift.  # noqa: E501
        ...
        :return: The use_numbers of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: str
        """
    ...
    def use_numbers(self, use_numbers):
        """Sets the use_numbers of this GatewayCreateProducerRedshift.

        Specifies whether the generated temporary password must contain at least one numeric character (0 to 9). [true/false]  # noqa: E501

        :param use_numbers: The use_numbers of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: str
        """
    ...
    def use_special_characters(self):
        """Gets the use_special_characters of this GatewayCreateProducerRedshift.  # noqa: E501


        :return: The use_special_characters of this GatewayCreateProducerRedshift.  # noqa: E501
        :rtype: str
        """
    ...
    def use_special_characters(self, use_special_characters):
        """Sets the use_special_characters of this GatewayCreateProducerRedshift.


        :param use_special_characters: The use_special_characters of this GatewayCreateProducerRedshift.  # noqa: E501
        :type: str
        """
