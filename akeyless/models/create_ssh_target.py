...
class CreateSSHTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "host", "json", "key", "max-versions", "name", "port", "private-key", "private-key-password", "ssh-password", "ssh-username", "token", "uid-token"]
