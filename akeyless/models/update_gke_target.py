...
class UpdateGKETarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "gke-account-key", "gke-cluster-cert", "gke-cluster-endpoint", "gke-cluster-name", "gke-service-account-email", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-cloud-identity"]
