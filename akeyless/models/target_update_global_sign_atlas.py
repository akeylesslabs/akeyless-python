...
class TargetUpdateGlobalSignAtlas(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api-key", "api-secret", "description", "json", "keep-prev-version", "key", "max-versions", "mtls-cert-data-base64", "mtls-key-data-base64", "name", "new-name", "timeout", "token", "uid-token"]
