...
class UpdateAuthMethodLDAP(BaseModel):
    """
    ...
    gen_key: Optional[StrictStr] = Field(default=None, description="Automatically generate key-pair for LDAP configuration. If set to false, a public key needs to be provided [true/false]", alias="gen-key")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gen-key", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "public-key-data", "token", "uid-token", "unique-identifier"]
