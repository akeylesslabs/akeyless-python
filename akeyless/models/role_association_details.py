...
class RoleAssociationDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assoc_id", "auth_method_name", "auth_method_sub_claims", "is_subclaims_with_operator", "role_name", "sub_claims_case_sensitive"]
