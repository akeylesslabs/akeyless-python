...
class GatewayCreateProducerPostgreSQL(object):
    ...
    def custom_username_template(self):
        """Gets the custom_username_template of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Customize how temporary usernames are generated using go template  # noqa: E501

        :return: The custom_username_template of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_username_template(self, custom_username_template):
        """Sets the custom_username_template of this GatewayCreateProducerPostgreSQL.

        Customize how temporary usernames are generated using go template  # noqa: E501

        :param custom_username_template: The custom_username_template of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def enable_agentic_runtime_authority(self):
        """Gets the enable_agentic_runtime_authority of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        ...
        :return: The enable_agentic_runtime_authority of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_agentic_runtime_authority(self, enable_agentic_runtime_authority):
        """Sets the enable_agentic_runtime_authority of this GatewayCreateProducerPostgreSQL.

        EnableAra is the documented spelling of AraEnabled; --ara-enabled shipped first and stays as an undocumented alias.  # noqa: E501

        :param enable_agentic_runtime_authority: The enable_agentic_runtime_authority of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: bool
        """
    ...
    def enable_ai_quorum(self):
        """Gets the enable_ai_quorum of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Turns on AI Quorum checks for this item.  # noqa: E501

        :return: The enable_ai_quorum of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_ai_quorum(self, enable_ai_quorum):
        """Sets the enable_ai_quorum of this GatewayCreateProducerPostgreSQL.

        Turns on AI Quorum checks for this item.  # noqa: E501

        :param enable_ai_quorum: The enable_ai_quorum of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        ...
        :return: The input_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this GatewayCreateProducerPostgreSQL.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).  # noqa: E501

        :param input_rule: The input_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: list[str]
        """
    ...
    def item_custom_fields(self):
        """Gets the item_custom_fields of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Additional custom fields to associate with the item  # noqa: E501

        :return: The item_custom_fields of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def item_custom_fields(self, item_custom_fields):
        """Sets the item_custom_fields of this GatewayCreateProducerPostgreSQL.

        Additional custom fields to associate with the item  # noqa: E501

        :param item_custom_fields: The item_custom_fields of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def json(self):
        """Gets the json of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Set output format to JSON  # noqa: E501

        :return: The json of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: bool
        """
        return self._json
    ...
    @json.setter
    def json(self, json):
        """Sets the json of this GatewayCreateProducerPostgreSQL.

        Set output format to JSON  # noqa: E501

        :param json: The json of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: bool
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this GatewayCreateProducerPostgreSQL.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: list[str]
        """
    ...
    def secure_access_certificate_issuer(self):
        """Gets the secure_access_certificate_issuer of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Path to the SSH Certificate Issuer for your Akeyless Secure Access  # noqa: E501

        :return: The secure_access_certificate_issuer of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def secure_access_certificate_issuer(self, secure_access_certificate_issuer):
        """Sets the secure_access_certificate_issuer of this GatewayCreateProducerPostgreSQL.

        Path to the SSH Certificate Issuer for your Akeyless Secure Access  # noqa: E501

        :param secure_access_certificate_issuer: The secure_access_certificate_issuer of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def secure_access_db_name(self):
        """Gets the secure_access_db_name of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        The DB name (relevant only for DB Dynamic-Secret)  # noqa: E501

        :return: The secure_access_db_name of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def secure_access_db_name(self, secure_access_db_name):
        """Sets the secure_access_db_name of this GatewayCreateProducerPostgreSQL.

        The DB name (relevant only for DB Dynamic-Secret)  # noqa: E501

        :param secure_access_db_name: The secure_access_db_name of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def secure_access_delay(self):
        """Gets the secure_access_delay of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds  # noqa: E501

        :return: The secure_access_delay of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: int
        """
    ...
    def secure_access_delay(self, secure_access_delay):
        """Sets the secure_access_delay of this GatewayCreateProducerPostgreSQL.

        The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds  # noqa: E501

        :param secure_access_delay: The secure_access_delay of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: int
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this GatewayCreateProducerPostgreSQL.  # noqa: E501

        Add tags attached to this object  # noqa: E501

        :return: The tags of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this GatewayCreateProducerPostgreSQL.

        Add tags attached to this object  # noqa: E501

        :param tags: The tags of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: list[str]
        """
    ...
    def use_capital_letters(self):
        """Gets the use_capital_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        ...
        :return: The use_capital_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def use_capital_letters(self, use_capital_letters):
        """Sets the use_capital_letters of this GatewayCreateProducerPostgreSQL.

        Specifies whether the generated temporary password must contain at least one uppercase character from the ISO basic Latin alphabet (A to Z). [true/false]  # noqa: E501

        :param use_capital_letters: The use_capital_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def use_lower_letters(self):
        """Gets the use_lower_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        ...
        :return: The use_lower_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def use_lower_letters(self, use_lower_letters):
        """Sets the use_lower_letters of this GatewayCreateProducerPostgreSQL.

        Specifies whether the generated temporary password must contain at least one lowercase character from the ISO basic Latin alphabet (a to z). [true/false]  # noqa: E501

        :param use_lower_letters: The use_lower_letters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def use_numbers(self):
        """Gets the use_numbers of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        ...
        :return: The use_numbers of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def use_numbers(self, use_numbers):
        """Sets the use_numbers of this GatewayCreateProducerPostgreSQL.

        Specifies whether the generated temporary password must contain at least one numeric character (0 to 9). [true/false]  # noqa: E501

        :param use_numbers: The use_numbers of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
    ...
    def use_special_characters(self):
        """Gets the use_special_characters of this GatewayCreateProducerPostgreSQL.  # noqa: E501


        :return: The use_special_characters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :rtype: str
        """
    ...
    def use_special_characters(self, use_special_characters):
        """Sets the use_special_characters of this GatewayCreateProducerPostgreSQL.


        :param use_special_characters: The use_special_characters of this GatewayCreateProducerPostgreSQL.  # noqa: E501
        :type: str
        """
