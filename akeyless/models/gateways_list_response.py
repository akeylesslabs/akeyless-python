...
class GatewaysListResponse(BaseModel):
    ...
    """ # noqa: E501
    clusters: Optional[List[GwClusterIdentity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [GwClusterIdentity.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
