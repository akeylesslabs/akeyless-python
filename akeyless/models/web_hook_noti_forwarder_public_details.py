...
class WebHookNotiForwarderPublicDetails(BaseModel):
    """
    WebHookNotiForwarderPublicDetails
    """ # noqa: E501
    auth_type: Optional[StrictStr] = None
    endpoint_url: Optional[StrictStr] = None
    username: Optional[StrictStr] = Field(default=None, description="Auth type - User Password")
    __properties: ClassVar[List[str]] = ["auth_type", "endpoint_url", "username"]
