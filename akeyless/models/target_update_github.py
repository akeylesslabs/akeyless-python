...
class TargetUpdateGithub(BaseModel):
    """
    TargetUpdateGithub
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "github-app-id", "github-app-private-key", "github-base-url", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token"]
