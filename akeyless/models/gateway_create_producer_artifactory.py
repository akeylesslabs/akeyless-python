...
class GatewayCreateProducerArtifactory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["artifactory-admin-name", "artifactory-admin-pwd", "artifactory-token-audience", "artifactory-token-scope", "base-url", "delete_protection", "json", "name", "producer-encryption-key-name", "tags", "target-name", "token", "uid-token", "user-ttl"]
