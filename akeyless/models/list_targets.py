...
class ListTargets(BaseModel):
    """
    listTargets is a command that returns a list of targets. [Deprecated: Use target-list command]
    """ # noqa: E501
    filter: Optional[StrictStr] = Field(default=None, description="Filter by auth method name or part of it")
    ...
    type: Optional[List[StrictStr]] = Field(default=None, description="The target types list . In case it is empty, all types of targets will be returned. options: [hanadb cassandra aws ssh gke eks mysql mongodb snowflake mssql redshift artifactory azure rabbitmq k8s venafi gcp oracle dockerhub ldap github chef web salesforce postgres]")
    ...
    __properties: ClassVar[List[str]] = ["filter", "json", "pagination-token", "token", "type", "uid-token"]
