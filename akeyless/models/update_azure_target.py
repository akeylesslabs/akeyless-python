...
class UpdateAzureTarget(object):
    ...
    def __init__(self, client_id=None, client_secret=None, comment=None, key=None, name=None, new_name=None, password=None, tenant_id=None, token=None, uid_token=None, update_version=False, username=None, local_vars_configuration=None):  # noqa: E501
