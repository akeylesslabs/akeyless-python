...
class UpdateAzureTarget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client-id", "client-secret", "comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "resource-group-name", "resource-name", "subscription-id", "tenant-id", "token", "uid-token", "update-version", "use-gw-cloud-identity"]
