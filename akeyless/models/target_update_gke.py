...
class TargetUpdateGke(BaseModel):
    """
    TargetUpdateGke
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "gke-account-key", "gke-cluster-cert", "gke-cluster-endpoint", "gke-cluster-name", "gke-service-account-email", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "use-gw-cloud-identity"]
