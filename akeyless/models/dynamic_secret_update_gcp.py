...
class DynamicSecretUpdateGcp(object):
    ...
    def __init__(self, custom_username_template=None, delete_protection=None, description=None, gcp_cred_type=None, gcp_key=None, gcp_key_algo=None, gcp_project_id=None, gcp_sa_email=None, gcp_token_scopes=None, json=False, name=None, new_name=None, producer_encryption_key_name=None, role_binding=None, service_account_type='fixed', tags=None, target_name=None, token=None, uid_token=None, user_ttl='60m', local_vars_configuration=None):  # noqa: E501
