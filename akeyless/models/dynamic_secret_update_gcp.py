...
class DynamicSecretUpdateGcp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "description", "gcp-cred-type", "gcp-key", "gcp-key-algo", "gcp-sa-email", "gcp-token-scopes", "json", "name", "new-name", "producer-encryption-key-name", "role-binding", "service-account-type", "tags", "target-name", "token", "uid-token", "user-ttl"]
