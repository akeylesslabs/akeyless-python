...
class RotatedSecretDeleteSync(BaseModel):
    """
    ...
    usc_name: StrictStr = Field(description="Universal Secret Connector name", alias="usc-name")
    __properties: ClassVar[List[str]] = ["json", "name", "token", "uid-token", "usc-name"]
