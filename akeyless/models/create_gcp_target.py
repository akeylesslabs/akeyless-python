...
class CreateGcpTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "gcp-key", "json", "key", "max-versions", "name", "token", "uid-token", "use-gw-cloud-identity"]
