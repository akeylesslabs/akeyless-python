...
class TargetUpdateSectigo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["certificate-profile-id", "customer-uri", "description", "external-requester", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "organization-id", "password", "timeout", "token", "uid-token", "username"]
