...
class RotatedSecretCreateCustom(BaseModel):
    """
    ...
    custom_payload: Optional[StrictStr] = Field(default=None, description="Secret payload to be sent with rotation request", alias="custom-payload")
    ...
    timeout_sec: Optional[StrictInt] = Field(default=40, description="Maximum allowed time in seconds for the custom rotator to return the results", alias="timeout-sec")
    ...
    __properties: ClassVar[List[str]] = ["authentication-credentials", "auto-rotate", "custom-payload", "delete_protection", "description", "json", "key", "max-versions", "name", "password-length", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-allow-external-user", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-rdp-domain", "secure-access-rdp-user", "secure-access-ssh-user", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "tags", "target-name", "timeout-sec", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeout-sec": obj.get("timeout-sec") if obj.get("timeout-sec") is not None else 40,
            "token": obj.get("token"),
