...
class EventForwarderCreateEmail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auth-methods-event-source-locations", "description", "email-to", "event-types", "every", "gateways-event-source-locations", "include-error", "items-event-source-locations", "json", "key", "name", "override-url", "runner-type", "targets-event-source-locations", "token", "uid-token"]
