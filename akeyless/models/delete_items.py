...
class DeleteItems(BaseModel):
    ...
    DeleteItems
    """ # noqa: E501
    item: Optional[List[StrictStr]] = Field(default=None, description="A list of items to delete, To specify multiple items use argument multiple times")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    path: Optional[StrictStr] = Field(default=None, description="Path to delete the items from")
    ...
    __properties: ClassVar[List[str]] = ["item", "json", "path", "token", "uid-token"]
