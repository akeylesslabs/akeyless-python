...
class UpdateAuthMethodUniversalIdentity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "bound-ips", "delete_protection", "deny-inheritance", "deny-rotate", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "token", "ttl", "uid-token"]
