...
class UniversalIdentityDetails(BaseModel):
    """
    UniversalIdentityDetails
    """ # noqa: E501
    max_depth: Optional[StrictInt] = None
    number_of_tokens: Optional[StrictInt] = None
    root: Optional[UIDTokenDetails] = None
    __properties: ClassVar[List[str]] = ["max_depth", "number_of_tokens", "root"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "number_of_tokens": obj.get("number_of_tokens"),
            "root": UIDTokenDetails.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
