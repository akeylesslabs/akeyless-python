...
class GetCertificateValueOutput(BaseModel):
    """
    GetCertificateValueOutput
    """ # noqa: E501
    certificate_pem: Optional[StrictStr] = None
    private_key_pem: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["certificate_pem", "private_key_pem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "private_key_pem": obj.get("private_key_pem")
        })
        return _obj
