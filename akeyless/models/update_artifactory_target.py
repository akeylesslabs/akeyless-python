...
class UpdateArtifactoryTarget(BaseModel):
    """
    updateArtifactoryTarget is a command that updates a new target. [Deprecated: Use target-update-artifactory command]
    """ # noqa: E501
    artifactory_admin_name: StrictStr = Field(description="Artifactory Admin Name", alias="artifactory-admin-name")
    artifactory_admin_pwd: StrictStr = Field(description="Artifactory Admin password", alias="artifactory-admin-pwd")
    base_url: StrictStr = Field(description="Base URL", alias="base-url")
    ...
    __properties: ClassVar[List[str]] = ["artifactory-admin-name", "artifactory-admin-pwd", "base-url", "comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version"]
