...
class DynamicSecretCreateGke(object):
    ...
    def ara_enabled(self):
        """Gets the ara_enabled of this DynamicSecretCreateGke.  # noqa: E501
        ...
        :return: The ara_enabled of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: bool
        """
    ...
    def ara_enabled(self, ara_enabled):
        """Sets the ara_enabled of this DynamicSecretCreateGke.

        Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.  # noqa: E501

        :param ara_enabled: The ara_enabled of this DynamicSecretCreateGke.  # noqa: E501
        :type: bool
        """
    ...
    def enable_agentic_runtime_authority(self):
        """Gets the enable_agentic_runtime_authority of this DynamicSecretCreateGke.  # noqa: E501
        ...
        :return: The enable_agentic_runtime_authority of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_agentic_runtime_authority(self, enable_agentic_runtime_authority):
        """Sets the enable_agentic_runtime_authority of this DynamicSecretCreateGke.

        EnableAra is the documented spelling of AraEnabled; --ara-enabled shipped first and stays as an undocumented alias.  # noqa: E501

        :param enable_agentic_runtime_authority: The enable_agentic_runtime_authority of this DynamicSecretCreateGke.  # noqa: E501
        :type: bool
        """
    ...
    def enable_ai_quorum(self):
        """Gets the enable_ai_quorum of this DynamicSecretCreateGke.  # noqa: E501

        Turns on AI Quorum checks for this item.  # noqa: E501

        :return: The enable_ai_quorum of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_ai_quorum(self, enable_ai_quorum):
        """Sets the enable_ai_quorum of this DynamicSecretCreateGke.

        Turns on AI Quorum checks for this item.  # noqa: E501

        :param enable_ai_quorum: The enable_ai_quorum of this DynamicSecretCreateGke.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this DynamicSecretCreateGke.  # noqa: E501
        ...
        :return: The input_rule of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this DynamicSecretCreateGke.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).  # noqa: E501

        :param input_rule: The input_rule of this DynamicSecretCreateGke.  # noqa: E501
        :type: list[str]
        """
    ...
    def item_custom_fields(self):
        """Gets the item_custom_fields of this DynamicSecretCreateGke.  # noqa: E501

        Additional custom fields to associate with the item  # noqa: E501

        :return: The item_custom_fields of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def item_custom_fields(self, item_custom_fields):
        """Sets the item_custom_fields of this DynamicSecretCreateGke.

        Additional custom fields to associate with the item  # noqa: E501

        :param item_custom_fields: The item_custom_fields of this DynamicSecretCreateGke.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this DynamicSecretCreateGke.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this DynamicSecretCreateGke.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this DynamicSecretCreateGke.  # noqa: E501
        :type: list[str]
        """
    ...
    def secure_access_certificate_issuer(self):
        """Gets the secure_access_certificate_issuer of this DynamicSecretCreateGke.  # noqa: E501

        Path to the SSH Certificate Issuer for your Akeyless Secure Access  # noqa: E501

        :return: The secure_access_certificate_issuer of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: str
        """
    ...
    def secure_access_certificate_issuer(self, secure_access_certificate_issuer):
        """Sets the secure_access_certificate_issuer of this DynamicSecretCreateGke.

        Path to the SSH Certificate Issuer for your Akeyless Secure Access  # noqa: E501

        :param secure_access_certificate_issuer: The secure_access_certificate_issuer of this DynamicSecretCreateGke.  # noqa: E501
        :type: str
        """
    ...
    def secure_access_delay(self):
        """Gets the secure_access_delay of this DynamicSecretCreateGke.  # noqa: E501

        The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds  # noqa: E501

        :return: The secure_access_delay of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: int
        """
    ...
    def secure_access_delay(self, secure_access_delay):
        """Sets the secure_access_delay of this DynamicSecretCreateGke.

        The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds  # noqa: E501

        :param secure_access_delay: The secure_access_delay of this DynamicSecretCreateGke.  # noqa: E501
        :type: int
        """
    ...
    def skip_dry_run(self):
        """Gets the skip_dry_run of this DynamicSecretCreateGke.  # noqa: E501

        If set, dry-run will be skipped  # noqa: E501

        :return: The skip_dry_run of this DynamicSecretCreateGke.  # noqa: E501
        :rtype: str
        """
    ...
    def skip_dry_run(self, skip_dry_run):
        """Sets the skip_dry_run of this DynamicSecretCreateGke.

        If set, dry-run will be skipped  # noqa: E501

        :param skip_dry_run: The skip_dry_run of this DynamicSecretCreateGke.  # noqa: E501
        :type: str
        """
