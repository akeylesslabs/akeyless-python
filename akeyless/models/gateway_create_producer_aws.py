...
class GatewayCreateProducerAws(object):
    ...
    def __init__(self, access_mode=None, admin_rotation_interval_days=0, aws_access_key_id=None, aws_access_secret_key=None, aws_external_id=None, aws_role_arns=None, aws_user_console_access=False, aws_user_groups=None, aws_user_policies=None, aws_user_programmatic_access=True, custom_username_template=None, delete_protection=None, enable_admin_rotation=False, item_custom_fields=None, json=False, name=None, password_length=None, producer_encryption_key_name=None, region='us-east-2', secure_access_aws_account_id=None, secure_access_aws_native_cli=None, secure_access_bastion_issuer=None, secure_access_certificate_issuer=None, secure_access_delay=None, secure_access_enable=None, secure_access_web=True, secure_access_web_browsing=False, secure_access_web_proxy=False, session_tags=None, tags=None, target_name=None, token=None, transitive_tag_keys=None, uid_token=None, user_ttl='60m', local_vars_configuration=None):  # noqa: E501
