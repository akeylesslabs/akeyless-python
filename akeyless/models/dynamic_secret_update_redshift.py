...
class DynamicSecretUpdateRedshift(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creation-statements", "delete_protection", "description", "json", "name", "new-name", "password-length", "producer-encryption-key", "redshift-db-name", "redshift-host", "redshift-password", "redshift-port", "redshift-username", "secure-access-enable", "secure-access-host", "ssl", "tags", "target-name", "token", "uid-token", "user-ttl"]
