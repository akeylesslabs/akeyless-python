...
class CreateGlobalSignAtlasTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api-key", "api-secret", "comment", "description", "json", "key", "max-versions", "mtls-cert-data-base64", "mtls-key-data-base64", "name", "timeout", "token", "uid-token"]
