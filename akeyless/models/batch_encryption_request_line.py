...
class BatchEncryptionRequestLine(BaseModel):
    """
    ...
    item_version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["context", "data", "item_id", "item_version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item_version": obj.get("item_version")
        })
        return _obj
