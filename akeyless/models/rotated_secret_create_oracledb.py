...
class RotatedSecretCreateOracledb(object):
    ...
    def __init__(self, ara_enabled=None, authentication_credentials='use-user-creds', auto_rotate=None, delete_protection=None, description=None, enable_agentic_runtime_authority=None, enable_ai_quorum=None, input_rule=None, item_custom_fields=None, json=False, key=None, lock_during_sra_session=None, lock_on_read=None, lock_ttl=None, max_versions=None, name=None, output_rule=None, password_length=None, rotate_after_disconnect=None, rotate_on_unlock=None, rotated_password=None, rotated_username=None, rotation_event_in=None, rotation_hour=None, rotation_interval=None, rotator_type=None, secure_access_db_name=None, secure_access_enable=None, secure_access_host=None, secure_access_web=False, skip_dry_run=None, tags=None, target_name=None, token=None, uid_token=None, use_capital_letters=None, use_lower_letters=None, use_numbers=None, use_special_characters=None, local_vars_configuration=None):  # noqa: E501
    ...
    def ara_enabled(self):
        """Gets the ara_enabled of this RotatedSecretCreateOracledb.  # noqa: E501
        ...
        :return: The ara_enabled of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: bool
        """
    ...
    def ara_enabled(self, ara_enabled):
        """Sets the ara_enabled of this RotatedSecretCreateOracledb.

        Enable or disable Agentic Runtime Authority rule enforcement for this item. When false, user-defined input/output rules are stored but not enforced; the base security validation still runs.  AraEnabled is tri-state (nil/true/false), not a plain bool: it self-encodes its wire value (see akl.OptionalBool) so an explicit false survives the curl-proxy relay instead of being dropped like a default-false bool flag.  # noqa: E501

        :param ara_enabled: The ara_enabled of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: bool
        """
    ...
    def enable_agentic_runtime_authority(self):
        """Gets the enable_agentic_runtime_authority of this RotatedSecretCreateOracledb.  # noqa: E501
        ...
        :return: The enable_agentic_runtime_authority of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_agentic_runtime_authority(self, enable_agentic_runtime_authority):
        """Sets the enable_agentic_runtime_authority of this RotatedSecretCreateOracledb.

        EnableAra is the documented spelling of AraEnabled. Both set the same field; --ara-enabled shipped first and stays as an undocumented alias so existing scripts and the Terraform provider keep working.  # noqa: E501

        :param enable_agentic_runtime_authority: The enable_agentic_runtime_authority of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: bool
        """
    ...
    def enable_ai_quorum(self):
        """Gets the enable_ai_quorum of this RotatedSecretCreateOracledb.  # noqa: E501

        Turns on AI Quorum checks for this item.  # noqa: E501

        :return: The enable_ai_quorum of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_ai_quorum(self, enable_ai_quorum):
        """Sets the enable_ai_quorum of this RotatedSecretCreateOracledb.

        Turns on AI Quorum checks for this item.  # noqa: E501

        :param enable_ai_quorum: The enable_ai_quorum of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this RotatedSecretCreateOracledb.  # noqa: E501

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)  # noqa: E501

        :return: The input_rule of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this RotatedSecretCreateOracledb.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)  # noqa: E501

        :param input_rule: The input_rule of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: list[str]
        """
    ...
    def item_custom_fields(self):
        """Gets the item_custom_fields of this RotatedSecretCreateOracledb.  # noqa: E501

        Additional custom fields to associate with the item  # noqa: E501

        :return: The item_custom_fields of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def item_custom_fields(self, item_custom_fields):
        """Sets the item_custom_fields of this RotatedSecretCreateOracledb.

        Additional custom fields to associate with the item  # noqa: E501

        :param item_custom_fields: The item_custom_fields of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def lock_during_sra_session(self):
        """Gets the lock_during_sra_session of this RotatedSecretCreateOracledb.  # noqa: E501

        Lock this secret for read/update while an SRA session is active  # noqa: E501

        :return: The lock_during_sra_session of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def lock_during_sra_session(self, lock_during_sra_session):
        """Sets the lock_during_sra_session of this RotatedSecretCreateOracledb.

        Lock this secret for read/update while an SRA session is active  # noqa: E501

        :param lock_during_sra_session: The lock_during_sra_session of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def lock_on_read(self):
        """Gets the lock_on_read of this RotatedSecretCreateOracledb.  # noqa: E501

        Lock this secret after each successful value read  # noqa: E501

        :return: The lock_on_read of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def lock_on_read(self, lock_on_read):
        """Sets the lock_on_read of this RotatedSecretCreateOracledb.

        Lock this secret after each successful value read  # noqa: E501

        :param lock_on_read: The lock_on_read of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lock_ttl(self):
        """Gets the lock_ttl of this RotatedSecretCreateOracledb.  # noqa: E501

        Lock TTL in minutes  # noqa: E501

        :return: The lock_ttl of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def lock_ttl(self, lock_ttl):
        """Sets the lock_ttl of this RotatedSecretCreateOracledb.

        Lock TTL in minutes  # noqa: E501

        :param lock_ttl: The lock_ttl of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def max_versions(self):
        """Gets the max_versions of this RotatedSecretCreateOracledb.  # noqa: E501

        Set the maximum number of versions, limited by the account settings defaults.  # noqa: E501

        :return: The max_versions of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def max_versions(self, max_versions):
        """Sets the max_versions of this RotatedSecretCreateOracledb.

        Set the maximum number of versions, limited by the account settings defaults.  # noqa: E501

        :param max_versions: The max_versions of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this RotatedSecretCreateOracledb.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this RotatedSecretCreateOracledb.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: list[str]
        """
    ...
    def rotate_on_unlock(self):
        """Gets the rotate_on_unlock of this RotatedSecretCreateOracledb.  # noqa: E501

        Rotate this secret after it is unlocked  # noqa: E501

        :return: The rotate_on_unlock of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def rotate_on_unlock(self, rotate_on_unlock):
        """Sets the rotate_on_unlock of this RotatedSecretCreateOracledb.

        Rotate this secret after it is unlocked  # noqa: E501

        :param rotate_on_unlock: The rotate_on_unlock of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def rotation_event_in(self):
        """Gets the rotation_event_in of this RotatedSecretCreateOracledb.  # noqa: E501

        How many days before the rotation of the item would you like to be notified  # noqa: E501

        :return: The rotation_event_in of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def rotation_event_in(self, rotation_event_in):
        """Sets the rotation_event_in of this RotatedSecretCreateOracledb.

        How many days before the rotation of the item would you like to be notified  # noqa: E501

        :param rotation_event_in: The rotation_event_in of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: list[str]
        """
    ...
    def skip_dry_run(self):
        """Gets the skip_dry_run of this RotatedSecretCreateOracledb.  # noqa: E501

        If set, dry-run will be skipped  # noqa: E501

        :return: The skip_dry_run of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def skip_dry_run(self, skip_dry_run):
        """Sets the skip_dry_run of this RotatedSecretCreateOracledb.

        If set, dry-run will be skipped  # noqa: E501

        :param skip_dry_run: The skip_dry_run of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def use_capital_letters(self):
        """Gets the use_capital_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        ...
        :return: The use_capital_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def use_capital_letters(self, use_capital_letters):
        """Sets the use_capital_letters of this RotatedSecretCreateOracledb.

        Specifies whether the generated temporary password must contain at least one uppercase character from the ISO basic Latin alphabet (A to Z). [true/false]  # noqa: E501

        :param use_capital_letters: The use_capital_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def use_lower_letters(self):
        """Gets the use_lower_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        ...
        :return: The use_lower_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def use_lower_letters(self, use_lower_letters):
        """Sets the use_lower_letters of this RotatedSecretCreateOracledb.

        Specifies whether the generated temporary password must contain at least one lowercase character from the ISO basic Latin alphabet (a to z). [true/false]  # noqa: E501

        :param use_lower_letters: The use_lower_letters of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def use_numbers(self):
        """Gets the use_numbers of this RotatedSecretCreateOracledb.  # noqa: E501
        ...
        :return: The use_numbers of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def use_numbers(self, use_numbers):
        """Sets the use_numbers of this RotatedSecretCreateOracledb.

        Specifies whether the generated temporary password must contain at least one numeric character (0 to 9). [true/false]  # noqa: E501

        :param use_numbers: The use_numbers of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
    ...
    def use_special_characters(self):
        """Gets the use_special_characters of this RotatedSecretCreateOracledb.  # noqa: E501


        :return: The use_special_characters of this RotatedSecretCreateOracledb.  # noqa: E501
        :rtype: str
        """
    ...
    def use_special_characters(self, use_special_characters):
        """Sets the use_special_characters of this RotatedSecretCreateOracledb.


        :param use_special_characters: The use_special_characters of this RotatedSecretCreateOracledb.  # noqa: E501
        :type: str
        """
