...
class RotatedSecretCreateOracledb(object):
    ...
    def __init__(self, authentication_credentials='use-user-creds', auto_rotate=None, delete_protection=None, description=None, item_custom_fields=None, json=False, key=None, lock_during_sra_session=None, max_versions=None, name=None, password_length=None, rotate_after_disconnect=None, rotated_password=None, rotated_username=None, rotation_event_in=None, rotation_hour=None, rotation_interval=None, rotator_type=None, secure_access_db_name=None, secure_access_enable=None, secure_access_host=None, secure_access_web=False, tags=None, target_name=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
