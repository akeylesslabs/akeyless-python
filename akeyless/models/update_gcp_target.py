...
class UpdateGcpTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "gcp-key", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-cloud-identity"]
