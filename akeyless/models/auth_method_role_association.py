...
class AuthMethodRoleAssociation(object):
    ...
    openapi_types = {
        ...
        'is_sub_claims_case_sensitive': 'bool',
    ...
    def __init__(self, allowed_ops=None, assoc_id=None, auth_method_sub_claims=None, is_sub_claims_case_sensitive=None, is_subclaims_with_operator=None, role_id=None, role_name=None, rules=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._is_sub_claims_case_sensitive = None
        ...
        if is_sub_claims_case_sensitive is not None:
            self.is_sub_claims_case_sensitive = is_sub_claims_case_sensitive
    ...
    @property
    def is_sub_claims_case_sensitive(self):
        """Gets the is_sub_claims_case_sensitive of this AuthMethodRoleAssociation.  # noqa: E501


        :return: The is_sub_claims_case_sensitive of this AuthMethodRoleAssociation.  # noqa: E501
        :rtype: bool
        """
        return self._is_sub_claims_case_sensitive

    @is_sub_claims_case_sensitive.setter
    def is_sub_claims_case_sensitive(self, is_sub_claims_case_sensitive):
        """Sets the is_sub_claims_case_sensitive of this AuthMethodRoleAssociation.


        :param is_sub_claims_case_sensitive: The is_sub_claims_case_sensitive of this AuthMethodRoleAssociation.  # noqa: E501
        :type: bool
        """

        self._is_sub_claims_case_sensitive = is_sub_claims_case_sensitive

    @property
    def is_subclaims_with_operator(self):
        """Gets the is_subclaims_with_operator of this AuthMethodRoleAssociation.  # noqa: E501


        :return: The is_subclaims_with_operator of this AuthMethodRoleAssociation.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_subclaims_with_operator(self, is_subclaims_with_operator):
        """Sets the is_subclaims_with_operator of this AuthMethodRoleAssociation.


        :param is_subclaims_with_operator: The is_subclaims_with_operator of this AuthMethodRoleAssociation.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def role_id(self):
        """Gets the role_id of this AuthMethodRoleAssociation.  # noqa: E501


        :return: The role_id of this AuthMethodRoleAssociation.  # noqa: E501
        :rtype: int
        """
    ...
    def role_id(self, role_id):
        """Sets the role_id of this AuthMethodRoleAssociation.


        :param role_id: The role_id of this AuthMethodRoleAssociation.  # noqa: E501
        :type: int
        """
