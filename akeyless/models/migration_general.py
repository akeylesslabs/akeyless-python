...
class MigrationGeneral(BaseModel):
    """
    MigrationGeneral
    """ # noqa: E501
    id: Optional[StrictStr] = None
    last_migration: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "last_migration", "name", "new_name", "prefix", "protection_key", "status", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "last_migration": obj.get("last_migration"),
            "name": obj.get("name"),
