...
class TargetCreateGitlab(BaseModel):
    """
    TargetCreateGitlab
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "gitlab-access-token", "gitlab-certificate", "gitlab-url", "json", "key", "max-versions", "name", "token", "uid-token"]
