...
class CreateAWSTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access-key", "access-key-id", "comment", "description", "json", "key", "max-versions", "name", "region", "session-token", "token", "uid-token", "use-gw-cloud-identity"]
