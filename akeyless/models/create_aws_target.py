...
class CreateAwsTarget(object):
    ...
    def __init__(self, access_key=None, access_key_id=None, comment=None, name=None, protection_key=None, region=None, session_token=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
