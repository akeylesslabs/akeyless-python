...
class ClassicKeyStatusInfo(BaseModel):
    """
    ClassicKeyStatusInfo
    """ # noqa: E501
    error_date: Optional[datetime] = None
    last_error: Optional[StrictStr] = None
    last_status: Optional[StrictStr] = Field(default=None, description="ClassicKeyTargetStatus defines status of classic key target")
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["error_date", "last_error", "last_status", "version"]
