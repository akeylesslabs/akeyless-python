...
class AuthMethodCreateK8s(BaseModel):
    """
    ...
    gen_key: Optional[StrictStr] = Field(default='true', description="Automatically generate key-pair for K8S configuration. If set to false, a public key needs to be provided [true/false]", alias="gen-key")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audience", "audit-logs-claims", "bound-ips", "bound-namespaces", "bound-pod-names", "bound-sa-names", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gen-key", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "public-key", "token", "uid-token"]
