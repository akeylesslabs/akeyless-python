...
class KmipClientSetRule(BaseModel):
    """
    KmipClientSetRule
    """ # noqa: E501
    capability: List[StrictStr] = Field(description="Access capabilities")
    client_id: Optional[StrictStr] = Field(default=None, alias="client-id")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    name: Optional[StrictStr] = None
    path: StrictStr = Field(description="Access path")
    ...
    __properties: ClassVar[List[str]] = ["capability", "client-id", "json", "name", "path", "token", "uid-token"]
