...
class UpdateGodaddyTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api-key", "comment", "description", "imap-fqdn", "imap-password", "imap-port", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "secret", "timeout", "token", "uid-token", "update-version"]
