...
class UpdateAssoc(BaseModel):
    """
    updateAssoc is a command that updates the sub-claims of an association between role and auth method.
    """ # noqa: E501
    assoc_id: StrictStr = Field(description="The association id to be updated", alias="assoc-id")
    ...
    __properties: ClassVar[List[str]] = ["assoc-id", "case-sensitive", "json", "sub-claims", "token", "uid-token"]
