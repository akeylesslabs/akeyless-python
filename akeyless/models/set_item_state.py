...
class SetItemState(BaseModel):
    ...
    SetItemState
    """ # noqa: E501
    desired_state: StrictStr = Field(description="Desired item state (Enabled, Disabled)", alias="desired-state")
    ...
    version: Optional[StrictInt] = Field(default=0, description="The specific version you want to update: 0=item level state (default) (relevant only for keys)")
    __properties: ClassVar[List[str]] = ["desired-state", "json", "name", "token", "uid-token", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "desired-state": obj.get("desired-state"),
