...
class SignGPG(BaseModel):
    ...
    message: StrictStr = Field(description="The message to be signed in base64 format")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "item-id", "json", "key-name", "message", "passphrase", "token", "uid-token"]
