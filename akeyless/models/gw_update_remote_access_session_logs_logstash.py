...
class GwUpdateRemoteAccessSessionLogsLogstash(BaseModel):
    """
    gwUpdateRemoteAccessSessionLogsLogstash is a command that updates session log forwarding config (logstash target)
    """ # noqa: E501
    dns: Optional[StrictStr] = Field(default=None, description="Logstash dns")
    ...
    protocol: Optional[StrictStr] = Field(default=None, description="Logstash protocol [tcp/udp]")
    pull_interval: Optional[StrictStr] = Field(default='10', description="Pull interval in seconds", alias="pull-interval")
    tls_certificate: Optional[StrictStr] = Field(default='use-existing', description="Logstash tls certificate", alias="tls-certificate")
    ...
    __properties: ClassVar[List[str]] = ["dns", "enable", "enable-tls", "json", "output-format", "protocol", "pull-interval", "tls-certificate", "token", "uid-token"]
