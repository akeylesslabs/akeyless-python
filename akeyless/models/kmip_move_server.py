...
class KmipMoveServer(BaseModel):
    """
    ...
    new_root: StrictStr = Field(description="New root for the kmip server", alias="new-root")
    ...
    __properties: ClassVar[List[str]] = ["json", "new-root", "token", "uid-token"]
