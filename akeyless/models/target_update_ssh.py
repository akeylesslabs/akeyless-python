...
class TargetUpdateSsh(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "host", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "port", "private-key", "private-key-password", "ssh-password", "ssh-username", "token", "uid-token"]
