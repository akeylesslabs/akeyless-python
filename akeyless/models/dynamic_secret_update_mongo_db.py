...
class DynamicSecretUpdateMongoDb(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "description", "json", "mongodb-atlas-api-private-key", "mongodb-atlas-api-public-key", "mongodb-atlas-project-id", "mongodb-custom-data", "mongodb-default-auth-db", "mongodb-host-port", "mongodb-name", "mongodb-password", "mongodb-roles", "mongodb-server-uri", "mongodb-uri-options", "mongodb-username", "name", "new-name", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-web", "tags", "target-name", "token", "uid-token", "user-ttl"]
