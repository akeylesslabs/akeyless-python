...
class VenafiTargetDetails(BaseModel):
    """
    VenafiTargetDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["venafi_api_key", "venafi_base_url", "venafi_tpp_access_token", "venafi_tpp_client_id", "venafi_tpp_password", "venafi_tpp_refresh_token", "venafi_tpp_username", "venafi_use_tpp", "venafi_zone"]
