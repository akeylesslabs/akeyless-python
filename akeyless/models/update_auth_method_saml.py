...
class UpdateAuthMethodSAML(BaseModel):
    """
    ...
    idp_metadata_url: Optional[StrictStr] = Field(default=None, description="IDP metadata url", alias="idp-metadata-url")
    idp_metadata_xml_data: Optional[StrictStr] = Field(default=None, description="IDP metadata xml data", alias="idp-metadata-xml-data")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "allowed-redirect-uri", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "idp-metadata-url", "idp-metadata-xml-data", "json", "jwt-ttl", "name", "new-name", "product-type", "subclaims-delimiters", "token", "uid-token", "unique-identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "idp-metadata-url": obj.get("idp-metadata-url"),
            "idp-metadata-xml-data": obj.get("idp-metadata-xml-data"),
