...
class CreateSSHCertIssuer(BaseModel):
    """
    CreateSSHCertIssuer
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["ProviderType", "allowed-users", "delete_protection", "description", "extensions", "external-username", "fixed-user-claim-keyname", "host-provider", "json", "metadata", "name", "principals", "secure-access-api", "secure-access-bastion-api", "secure-access-bastion-ssh", "secure-access-enable", "secure-access-enforce-hosts-restriction", "secure-access-gateway", "secure-access-host", "secure-access-ssh", "secure-access-ssh-creds-user", "secure-access-use-internal-bastion", "secure-access-use-internal-ssh-access", "signer-key-name", "tag", "target", "token", "ttl", "uid-token"]
