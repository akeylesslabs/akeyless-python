...
class TargetCreateRabbitMq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "json", "key", "max-versions", "name", "rabbitmq-server-password", "rabbitmq-server-uri", "rabbitmq-server-user", "token", "uid-token"]
