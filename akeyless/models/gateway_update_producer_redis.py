...
class GatewayUpdateProducerRedis(object):
    ...
    def __init__(self, acl_rules=None, ara_enabled=None, custom_username_template=None, delete_protection=None, host='127.0.0.1', input_rule=None, item_custom_fields=None, json=False, name=None, new_name=None, output_rule=None, password=None, password_length=None, port='6379', producer_encryption_key_name=None, skip_dry_run=None, ssl=False, ssl_certificate=None, tags=None, target_name=None, token=None, uid_token=None, use_capital_letters=None, use_lower_letters=None, use_numbers=None, use_special_characters=None, user_ttl='60m', username=None, local_vars_configuration=None):  # noqa: E501
