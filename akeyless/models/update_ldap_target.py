...
class UpdateLdapTarget(BaseModel):
    """
    ...
    server_type: Optional[StrictStr] = Field(default=None, description="Set Ldap server type, Options:[OpenLDAP, ActiveDirectory]", alias="server-type")
    ...
    __properties: ClassVar[List[str]] = ["bind-dn", "bind-dn-password", "comment", "description", "json", "keep-prev-version", "key", "ldap-ca-cert", "ldap-url", "max-versions", "name", "new-name", "server-type", "token", "token-expiration", "uid-token", "update-version"]
