...
class UpdateDockerhubTarget(BaseModel):
    """
    ...
    dockerhub_password: Optional[StrictStr] = Field(default=None, description="Password for docker repository", alias="dockerhub-password")
    dockerhub_username: Optional[StrictStr] = Field(default=None, description="Username for docker repository", alias="dockerhub-username")
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "dockerhub-password", "dockerhub-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version"]
