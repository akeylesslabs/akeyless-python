...
class CreateGitlabTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "gitlab-access-token", "gitlab-certificate", "gitlab-url", "json", "key", "max-versions", "name", "token", "uid-token"]
