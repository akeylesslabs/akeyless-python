...
class CreateKeyOutput(BaseModel):
    """
    CreateKeyOutput
    """ # noqa: E501
    display_id: Optional[StrictStr] = None
    fragment_results: Optional[List[StrictInt]] = None
    item_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["display_id", "fragment_results", "item_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fragment_results": obj.get("fragment_results"),
