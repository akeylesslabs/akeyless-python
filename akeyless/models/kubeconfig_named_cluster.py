...
class KubeconfigNamedCluster(BaseModel):
    ...
    """ # noqa: E501
    cluster: Optional[KubeconfigCluster] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cluster", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cluster": KubeconfigCluster.from_dict(obj["cluster"]) if obj.get("cluster") is not None else None,
            "name": obj.get("name")
        })
        return _obj
