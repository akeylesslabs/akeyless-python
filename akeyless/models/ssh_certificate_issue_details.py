...
class SSHCertificateIssueDetails(object):
    ...
    openapi_types = {
        ...
        'externally_provided_user_sub_claim_key': 'str',
        'is_externally_provided_user': 'bool',
        'principals': 'list[str]',
        'static_key_id': 'str'
    }
    ...
    attribute_map = {
        ...
        'externally_provided_user_sub_claim_key': 'externally_provided_user_sub_claim_key',
        'is_externally_provided_user': 'is_externally_provided_user',
        'principals': 'principals',
        'static_key_id': 'static_key_id'
    }

    def __init__(self, allowed_domains=None, allowed_user_key_lengths=None, allowed_users=None, cert_type=None, critical_options=None, extensions=None, externally_provided_user_sub_claim_key=None, is_externally_provided_user=None, principals=None, static_key_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._externally_provided_user_sub_claim_key = None
        self._is_externally_provided_user = None
        ...
        if externally_provided_user_sub_claim_key is not None:
            self.externally_provided_user_sub_claim_key = externally_provided_user_sub_claim_key
        if is_externally_provided_user is not None:
            self.is_externally_provided_user = is_externally_provided_user
    ...
    @property
    def externally_provided_user_sub_claim_key(self):
        """Gets the externally_provided_user_sub_claim_key of this SSHCertificateIssueDetails.  # noqa: E501

        ExternallyProvidedUserSubClaimKey is the claim key name where the user name should be taken from  # noqa: E501

        :return: The externally_provided_user_sub_claim_key of this SSHCertificateIssueDetails.  # noqa: E501
        :rtype: str
        """
        return self._externally_provided_user_sub_claim_key

    @externally_provided_user_sub_claim_key.setter
    def externally_provided_user_sub_claim_key(self, externally_provided_user_sub_claim_key):
        """Sets the externally_provided_user_sub_claim_key of this SSHCertificateIssueDetails.

        ExternallyProvidedUserSubClaimKey is the claim key name where the user name should be taken from  # noqa: E501

        :param externally_provided_user_sub_claim_key: The externally_provided_user_sub_claim_key of this SSHCertificateIssueDetails.  # noqa: E501
        :type: str
        """

        self._externally_provided_user_sub_claim_key = externally_provided_user_sub_claim_key

    @property
    def is_externally_provided_user(self):
        """Gets the is_externally_provided_user of this SSHCertificateIssueDetails.  # noqa: E501

        IsExternallyProvidedUser is true if allow users should be taken from claims and not from AllowedUsers  # noqa: E501

        :return: The is_externally_provided_user of this SSHCertificateIssueDetails.  # noqa: E501
        :rtype: bool
        """
        return self._is_externally_provided_user

    @is_externally_provided_user.setter
    def is_externally_provided_user(self, is_externally_provided_user):
        """Sets the is_externally_provided_user of this SSHCertificateIssueDetails.

        IsExternallyProvidedUser is true if allow users should be taken from claims and not from AllowedUsers  # noqa: E501

        :param is_externally_provided_user: The is_externally_provided_user of this SSHCertificateIssueDetails.  # noqa: E501
        :type: bool
        """

        self._is_externally_provided_user = is_externally_provided_user
