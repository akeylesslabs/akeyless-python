...
class EncryptFile(object):
    ...
    @property
    def _in(self):
        """Gets the _in of this EncryptFile.  # noqa: E501

        Path to the file to be encrypted. If not provided, the content will be taken from stdin  # noqa: E501

        :return: The _in of this EncryptFile.  # noqa: E501
        :rtype: str
        """
        return self.__in
    ...
    @_in.setter
    def _in(self, _in):
        """Sets the _in of this EncryptFile.

        Path to the file to be encrypted. If not provided, the content will be taken from stdin  # noqa: E501

        :param _in: The _in of this EncryptFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key_name(self):
        """Gets the key_name of this EncryptFile.  # noqa: E501

        The name of the key to use in the encryption process  # noqa: E501

        :return: The key_name of this EncryptFile.  # noqa: E501
        :rtype: str
        """
    ...
    def key_name(self, key_name):
        """Sets the key_name of this EncryptFile.

        The name of the key to use in the encryption process  # noqa: E501

        :param key_name: The key_name of this EncryptFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def out(self):
        """Gets the out of this EncryptFile.  # noqa: E501

        Path to the output file. If not provided, the output will be sent to stdout  # noqa: E501

        :return: The out of this EncryptFile.  # noqa: E501
        :rtype: str
        """
        return self._out
    ...
    @out.setter
    def out(self, out):
        """Sets the out of this EncryptFile.

        Path to the output file. If not provided, the output will be sent to stdout  # noqa: E501

        :param out: The out of this EncryptFile.  # noqa: E501
        :type: str
        """
    ...
    def token(self):
        ...
        :return: The token of this EncryptFile.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this EncryptFile.

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :param token: The token of this EncryptFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid_token(self):
        """Gets the uid_token of this EncryptFile.  # noqa: E501

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :return: The uid_token of this EncryptFile.  # noqa: E501
        :rtype: str
        """
    ...
    def uid_token(self, uid_token):
        """Sets the uid_token of this EncryptFile.

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :param uid_token: The uid_token of this EncryptFile.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EncryptFile):
            return False
