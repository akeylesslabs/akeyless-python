...
class EncryptFile(BaseModel):
    ...
    var_in: StrictStr = Field(description="Path to the file to be encrypted. If not provided, the content will be taken from stdin", alias="in")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "in", "item-id", "json", "key-name", "out", "token", "uid-token"]
