...
class ChangeAdminAccountPassword(BaseModel):
    """
    ChangeAdminAccountPassword
    """ # noqa: E501
    current_password: StrictStr = Field(description="Current password", alias="current-password")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    new_password: StrictStr = Field(description="New password", alias="new-password")
    ...
    __properties: ClassVar[List[str]] = ["current-password", "json", "new-password", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current-password": obj.get("current-password"),
            "json": obj.get("json") if obj.get("json") is not None else False,
            "new-password": obj.get("new-password"),
            "token": obj.get("token"),
