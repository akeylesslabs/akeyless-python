...
class RollbackSecret(BaseModel):
    """
    RollbackSecret
    """ # noqa: E501
    ...
    old_version: StrictInt = Field(description="Old secret version to rollback to", alias="old-version")
    ...
    __properties: ClassVar[List[str]] = ["accessibility", "json", "name", "old-version", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "old-version": obj.get("old-version"),
            "token": obj.get("token"),
