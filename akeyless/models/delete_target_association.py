...
class DeleteTargetAssociation(BaseModel):
    """
    deleteTargetAssociation is a command that deletes an association between target and item.
    """ # noqa: E501
    assoc_id: Optional[StrictStr] = Field(default=None, description="The association id to be deleted", alias="assoc-id")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    name: StrictStr = Field(description="Item name")
    target_name: Optional[StrictStr] = Field(default=None, description="The target to associate", alias="target-name")
    ...
    __properties: ClassVar[List[str]] = ["assoc-id", "json", "name", "target-name", "token", "uid-token"]
