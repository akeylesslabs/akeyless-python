...
class RotatedSecretCreateCassandra(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authentication-credentials", "auto-rotate", "delete_protection", "description", "json", "key", "max-versions", "name", "password-length", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "tags", "target-name", "token", "uid-token"]
