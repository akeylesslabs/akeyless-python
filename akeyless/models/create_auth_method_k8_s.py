...
class CreateAuthMethodK8S(object):
    ...
    def __init__(self, access_expires=0, audience=None, bound_ips=None, bound_namespaces=None, bound_pod_names=None, bound_sa_names=None, force_sub_claims=None, gen_key='true', gw_bound_ips=None, json=False, jwt_ttl=0, name=None, public_key=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
