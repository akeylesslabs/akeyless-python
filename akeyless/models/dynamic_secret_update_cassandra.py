...
class DynamicSecretUpdateCassandra(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cassandra-creation-statements", "cassandra-hosts", "cassandra-password", "cassandra-port", "cassandra-username", "delete_protection", "description", "json", "name", "new-name", "password-length", "producer-encryption-key-name", "ssl", "ssl-certificate", "tags", "target-name", "token", "uid-token", "user-ttl"]
