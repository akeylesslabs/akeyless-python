...
class GatewayStatusMigration(BaseModel):
    """
    gatewayStatusMigration is a command that get migration status
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Migration ID")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    name: Optional[StrictStr] = Field(default=None, description="Migration name to display")
    ...
    __properties: ClassVar[List[str]] = ["id", "json", "name", "token", "uid-token"]
