...
class SignEcDsa(object):
    ...
    def __init__(self, display_id=None, item_id=None, json=False, key_name=None, message=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
