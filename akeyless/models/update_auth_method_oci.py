...
class UpdateAuthMethodOCI(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "group-ocid", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "tenant-ocid", "token", "uid-token"]
