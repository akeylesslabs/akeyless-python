...
class AuthMethodCreateOutput(BaseModel):
    """
    ...
    prv_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["access_id", "access_key", "name", "prv_key"]
