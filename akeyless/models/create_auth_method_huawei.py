...
class CreateAuthMethodHuawei(BaseModel):
    """
    ...
    auth_url: Optional[StrictStr] = Field(default='https://iam.myhwclouds.com:443/v3', description="sts URL", alias="auth-url")
    bound_domain_id: Optional[List[StrictStr]] = Field(default=None, description="A list of domain IDs that the access is restricted to", alias="bound-domain-id")
    bound_domain_name: Optional[List[StrictStr]] = Field(default=None, description="A list of domain names that the access is restricted to", alias="bound-domain-name")
    ...
    bound_tenant_id: Optional[List[StrictStr]] = Field(default=None, description="A list of full tenant ids that the access is restricted to", alias="bound-tenant-id")
    bound_tenant_name: Optional[List[StrictStr]] = Field(default=None, description="A list of full tenant names that the access is restricted to", alias="bound-tenant-name")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "auth-url", "bound-domain-id", "bound-domain-name", "bound-ips", "bound-tenant-id", "bound-tenant-name", "bound-user-id", "bound-user-name", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth-url": obj.get("auth-url") if obj.get("auth-url") is not None else 'https://iam.myhwclouds.com:443/v3',
            "bound-domain-id": obj.get("bound-domain-id"),
            "bound-domain-name": obj.get("bound-domain-name"),
            "bound-ips": obj.get("bound-ips"),
            "bound-tenant-id": obj.get("bound-tenant-id"),
            "bound-tenant-name": obj.get("bound-tenant-name"),
