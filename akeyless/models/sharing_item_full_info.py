...
class SharingItemFullInfo(BaseModel):
    """
    SharingItemFullInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["assigners", "capabilities", "cb", "is_limit_access", "name", "number_of_access_used", "number_of_allowed_access", "path", "start_time", "ttl", "type"]
