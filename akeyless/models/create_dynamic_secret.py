...
class CreateDynamicSecret(BaseModel):
    """
    CreateDynamicSecret
    """ # noqa: E501
    ...
    key: Optional[StrictStr] = Field(default=None, description="The name of a key that used to encrypt the dynamic secret values (if empty, the account default protectionKey key will be used)")
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "description", "json", "key", "metadata", "name", "tags", "token", "uid-token"]
