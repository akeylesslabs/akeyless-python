...
class TargetUpdateGodaddy(BaseModel):
    """
    TargetUpdateGodaddy
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["api-key", "description", "imap-fqdn", "imap-password", "imap-port", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "secret", "timeout", "token", "uid-token"]
