...
class EventAction(BaseModel):
    ...
    EventAction
    """ # noqa: E501
    action: StrictStr = Field(description="The Event Action [approve/deny]")
    event_id: StrictInt = Field(description="The Event ID", alias="event-id")
    ...
    __properties: ClassVar[List[str]] = ["action", "event-id", "json", "token", "uid-token"]
