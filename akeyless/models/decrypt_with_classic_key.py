...
class DecryptWithClassicKey(BaseModel):
    """
    DecryptWithClassicKey
    """ # noqa: E501
    ciphertext: StrictStr = Field(description="Ciphertext to be decrypted in base64 encoded format")
    display_id: StrictStr = Field(description="The name of the key to use in the encryption process", alias="display-id")
    ...
    __properties: ClassVar[List[str]] = ["ciphertext", "display-id", "json", "token", "uid-token", "version"]
