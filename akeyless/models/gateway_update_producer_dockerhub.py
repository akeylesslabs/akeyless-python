...
class GatewayUpdateProducerDockerhub(object):
    ...
    def __init__(self, dockerhub_password=None, dockerhub_token_scopes=None, dockerhub_username=None, name=None, new_name=None, producer_encryption_key_name=None, tags=None, target_name=None, token=None, uid_token=None, user_ttl='60m', local_vars_configuration=None):  # noqa: E501
