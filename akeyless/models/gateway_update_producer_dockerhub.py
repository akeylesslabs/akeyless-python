...
class GatewayUpdateProducerDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "dockerhub-password", "dockerhub-token-scopes", "dockerhub-username", "json", "name", "new-name", "producer-encryption-key-name", "tags", "target-name", "token", "uid-token", "user-ttl"]
