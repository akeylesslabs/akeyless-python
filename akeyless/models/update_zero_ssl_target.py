...
class UpdateZeroSSLTarget(BaseModel):
    """
    updateZeroSSLTarget is a command that updates an existing target. [Deprecated: Use target-update-zerossl command]
    """ # noqa: E501
    api_key: StrictStr = Field(description="API Key of the ZeroSSLTarget account", alias="api-key")
    ...
    imap_target_email: Optional[StrictStr] = Field(default=None, description="ImapValidationEmail to use when asking ZeroSSL to send a validation email, if empty will user imap-username", alias="imap-target-email")
    ...
    __properties: ClassVar[List[str]] = ["api-key", "comment", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "timeout", "token", "uid-token", "update-version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "imap-target-email": obj.get("imap-target-email"),
