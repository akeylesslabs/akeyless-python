...
class GatewayUpdateProducerGithub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "github-app-id", "github-app-private-key", "github-base-url", "installation-id", "installation-organization", "installation-repository", "json", "name", "new-name", "tags", "target-name", "token", "token-permissions", "token-repositories", "token-ttl", "uid-token"]
