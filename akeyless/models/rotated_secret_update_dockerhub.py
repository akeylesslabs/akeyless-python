...
class RotatedSecretUpdateDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["add-tag", "authentication-credentials", "auto-rotate", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password-length", "rm-tag", "rotation-event-in", "rotation-hour", "rotation-interval", "token", "uid-token"]
