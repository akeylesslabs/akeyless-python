...
class ClientsUsageReport(BaseModel):
    """
    ClientsUsageReport
    """ # noqa: E501
    account_id: Optional[StrictStr] = None
    clients: Optional[List[ClientUsageInfo]] = None
    product: Optional[StrictStr] = None
    time: Optional[datetime] = None
    total_clients: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["account_id", "clients", "product", "time", "total_clients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clients": [ClientUsageInfo.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None,
