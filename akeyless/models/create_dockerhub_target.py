...
class CreateDockerhubTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "description", "dockerhub-password", "dockerhub-username", "json", "key", "max-versions", "name", "token", "uid-token"]
