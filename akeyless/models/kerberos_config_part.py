...
class KerberosConfigPart(BaseModel):
    """
    KerberosConfigPart
    """ # noqa: E501
    kerberos_access_id: Optional[StrictStr] = None
    kerberos_keytab: Optional[StrictStr] = None
    kerberos_krb_5_conf: Optional[StrictStr] = None
    kerberos_private_key: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["kerberos_access_id", "kerberos_keytab", "kerberos_krb_5_conf", "kerberos_private_key", "ldap_anonymous_search", "ldap_bind_dn", "ldap_bind_password", "ldap_cert", "ldap_group_attr", "ldap_group_dn", "ldap_group_filter", "ldap_url", "ldap_user_attr", "ldap_user_dn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kerberos_access_id": obj.get("kerberos_access_id"),
            "kerberos_keytab": obj.get("kerberos_keytab"),
            "kerberos_krb_5_conf": obj.get("kerberos_krb_5_conf"),
            "kerberos_private_key": obj.get("kerberos_private_key"),
