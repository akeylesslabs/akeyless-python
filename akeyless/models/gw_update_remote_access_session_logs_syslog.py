...
class GwUpdateRemoteAccessSessionLogsSyslog(BaseModel):
    """
    ...
    enable_tls: Optional[StrictBool] = Field(default=None, description="Enable tls relevant only for network type TCP", alias="enable-tls")
    formatter: Optional[StrictStr] = Field(default='text', description="Syslog formatter [text/cef]")
    host: Optional[StrictStr] = Field(default=None, description="Syslog host")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    network: Optional[StrictStr] = Field(default='tcp', description="Syslog network [tcp/udp]")
    ...
    target_tag: Optional[StrictStr] = Field(default='use-existing', description="Syslog target tag", alias="target-tag")
    tls_certificate: Optional[StrictStr] = Field(default='use-existing', description="Syslog tls certificate", alias="tls-certificate")
    ...
    __properties: ClassVar[List[str]] = ["enable", "enable-tls", "formatter", "host", "json", "network", "output-format", "pull-interval", "target-tag", "tls-certificate", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formatter": obj.get("formatter") if obj.get("formatter") is not None else 'text',
            "host": obj.get("host"),
            "json": obj.get("json") if obj.get("json") is not None else False,
            "network": obj.get("network") if obj.get("network") is not None else 'tcp',
            ...
            "target-tag": obj.get("target-tag") if obj.get("target-tag") is not None else 'use-existing',
