...
class TargetUpdateArtifactory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["artifactory-admin-name", "artifactory-admin-pwd", "base-url", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token"]
