...
class UpdateTarget(object):
    ...
    def __init__(self, delete_protection=None, description='default_comment', json=False, max_versions=None, name=None, new_comment='default_comment', new_name=None, token=None, uid_token=None, local_vars_configuration=None):  # noqa: E501
