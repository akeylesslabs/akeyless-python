...
class TargetUpdateDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "dockerhub-password", "dockerhub-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token"]
