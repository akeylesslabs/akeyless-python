...
class RotatedSecretUpdateCustom(BaseModel):
    """
    ...
    timeout_sec: Optional[StrictInt] = Field(default=None, description="Maximum allowed time in seconds for the custom rotator to return the results", alias="timeout-sec")
    ...
    __properties: ClassVar[List[str]] = ["add-tag", "authentication-credentials", "auto-rotate", "custom-payload", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password-length", "rm-tag", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-allow-external-user", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-rdp-domain", "secure-access-rdp-user", "secure-access-ssh-user", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "timeout-sec", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeout-sec": obj.get("timeout-sec"),
            "token": obj.get("token"),
