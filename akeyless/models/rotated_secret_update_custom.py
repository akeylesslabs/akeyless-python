...
class RotatedSecretUpdateCustom(object):
    ...
    def __init__(self, provider_type=None, add_tag=None, ara_enabled=None, authentication_credentials='use-user-creds', auto_rotate=None, custom_payload=None, delete_protection=None, description='default_metadata', enable_password_policy=None, host_provider=None, input_rule=None, item_custom_fields=None, json=False, keep_prev_version=None, key=None, lock_during_sra_session=None, max_versions=None, name=None, new_name=None, output_rule=None, password_length=None, rm_tag=None, rotate_after_disconnect=None, rotation_event_in=None, rotation_hour=None, rotation_interval=None, secure_access_allow_external_user=False, secure_access_bastion_issuer=None, secure_access_certificate_issuer=None, secure_access_enable=None, secure_access_enforce_hosts_restriction=None, secure_access_host=None, secure_access_rdp_domain=None, secure_access_rdp_user=None, secure_access_ssh_user=None, secure_access_url=None, secure_access_web=False, secure_access_web_browsing=False, secure_access_web_proxy=False, skip_dry_run=None, target=None, timeout_sec=None, token=None, uid_token=None, use_capital_letters=None, use_lower_letters=None, use_numbers=None, use_special_characters=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this RotatedSecretUpdateCustom.  # noqa: E501

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)  # noqa: E501

        :return: The input_rule of this RotatedSecretUpdateCustom.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this RotatedSecretUpdateCustom.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)  # noqa: E501

        :param input_rule: The input_rule of this RotatedSecretUpdateCustom.  # noqa: E501
        :type: list[str]
        """
    ...
    def lock_during_sra_session(self):
        """Gets the lock_during_sra_session of this RotatedSecretUpdateCustom.  # noqa: E501

        Lock this secret for read/update while an SRA session is active  # noqa: E501

        :return: The lock_during_sra_session of this RotatedSecretUpdateCustom.  # noqa: E501
        :rtype: str
        """
    ...
    def lock_during_sra_session(self, lock_during_sra_session):
        """Sets the lock_during_sra_session of this RotatedSecretUpdateCustom.

        Lock this secret for read/update while an SRA session is active  # noqa: E501

        :param lock_during_sra_session: The lock_during_sra_session of this RotatedSecretUpdateCustom.  # noqa: E501
        :type: str
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this RotatedSecretUpdateCustom.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this RotatedSecretUpdateCustom.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this RotatedSecretUpdateCustom.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this RotatedSecretUpdateCustom.  # noqa: E501
        :type: list[str]
        """
