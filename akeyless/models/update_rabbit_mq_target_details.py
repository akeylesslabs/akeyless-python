...
class UpdateRabbitMQTargetDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["json", "keep-prev-version", "name", "new-version", "protection_key", "pwd", "token", "uid-token", "uri", "user"]
