...
class TargetCreateDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "dockerhub-password", "dockerhub-username", "json", "key", "max-versions", "name", "token", "uid-token"]
