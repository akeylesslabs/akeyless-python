...
class CreateHashiVaultTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "hashi-url", "json", "key", "max-versions", "name", "namespace", "token", "uid-token", "vault-token"]
