...
class DynamicSecretCreateDockerhub(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete_protection", "description", "dockerhub-password", "dockerhub-token-scopes", "dockerhub-username", "json", "name", "producer-encryption-key-name", "tags", "target-name", "token", "uid-token", "user-ttl"]
