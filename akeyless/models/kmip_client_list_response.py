...
class KMIPClientListResponse(BaseModel):
    """
    KMIPClientListResponse
    """ # noqa: E501
    clients: Optional[List[KMIPClient]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clients": [KMIPClient.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None
        })
        return _obj
