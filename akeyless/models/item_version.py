...
class ItemVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access_date", "access_date_display", "certificate_version_info", "creation_date", "customer_fragment_id", "deletion_date", "item_version_state", "modification_date", "protection_key_name", "version", "with_customer_fragment"]
