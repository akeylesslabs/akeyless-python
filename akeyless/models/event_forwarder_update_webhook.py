...
class EventForwarderUpdateWebhook(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auth-methods-event-source-locations", "auth-token", "auth-type", "client-cert-data", "description", "enable", "event-types", "gateways-event-source-locations", "items-event-source-locations", "json", "keep-prev-version", "key", "name", "new-name", "password", "private-key-data", "server-certificates", "targets-event-source-locations", "token", "uid-token", "url", "username"]
