...
class GatewayMigrationListOutput(BaseModel):
    """
    GatewayMigrationListOutput
    """ # noqa: E501
    body: Optional[MigrationsConfigPart] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": MigrationsConfigPart.from_dict(obj["body"]) if obj.get("body") is not None else None
        })
        return _obj
