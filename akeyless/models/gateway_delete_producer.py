...
class GatewayDeleteProducer(object):
    ...
    def enable_agentic_runtime_authority(self):
        """Gets the enable_agentic_runtime_authority of this GatewayDeleteProducer.  # noqa: E501
        ...
        :return: The enable_agentic_runtime_authority of this GatewayDeleteProducer.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_agentic_runtime_authority(self, enable_agentic_runtime_authority):
        """Sets the enable_agentic_runtime_authority of this GatewayDeleteProducer.

        EnableAra is the documented spelling of AraEnabled; --ara-enabled shipped first and stays as an undocumented alias.  # noqa: E501

        :param enable_agentic_runtime_authority: The enable_agentic_runtime_authority of this GatewayDeleteProducer.  # noqa: E501
        :type: bool
        """
    ...
    def enable_ai_quorum(self):
        """Gets the enable_ai_quorum of this GatewayDeleteProducer.  # noqa: E501

        Turns on AI Quorum checks for this item.  # noqa: E501

        :return: The enable_ai_quorum of this GatewayDeleteProducer.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_ai_quorum(self, enable_ai_quorum):
        """Sets the enable_ai_quorum of this GatewayDeleteProducer.

        Turns on AI Quorum checks for this item.  # noqa: E501

        :param enable_ai_quorum: The enable_ai_quorum of this GatewayDeleteProducer.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def input_rule(self):
        """Gets the input_rule of this GatewayDeleteProducer.  # noqa: E501
        ...
        :return: The input_rule of this GatewayDeleteProducer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_rule(self, input_rule):
        """Sets the input_rule of this GatewayDeleteProducer.

        Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).  # noqa: E501

        :param input_rule: The input_rule of this GatewayDeleteProducer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def json(self):
        """Gets the json of this GatewayDeleteProducer.  # noqa: E501

        Set output format to JSON  # noqa: E501

        :return: The json of this GatewayDeleteProducer.  # noqa: E501
        :rtype: bool
        """
        return self._json
    ...
    @json.setter
    def json(self, json):
        """Sets the json of this GatewayDeleteProducer.

        Set output format to JSON  # noqa: E501

        :param json: The json of this GatewayDeleteProducer.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this GatewayDeleteProducer.  # noqa: E501

        Dynamic secret name  # noqa: E501

        :return: The name of this GatewayDeleteProducer.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GatewayDeleteProducer.

        Dynamic secret name  # noqa: E501

        :param name: The name of this GatewayDeleteProducer.  # noqa: E501
        :type: str
        """
    ...
    def output_rule(self):
        """Gets the output_rule of this GatewayDeleteProducer.  # noqa: E501

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :return: The output_rule of this GatewayDeleteProducer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def output_rule(self, output_rule):
        """Sets the output_rule of this GatewayDeleteProducer.

        Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)  # noqa: E501

        :param output_rule: The output_rule of this GatewayDeleteProducer.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def token(self):
        """Gets the token of this GatewayDeleteProducer.  # noqa: E501

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :return: The token of this GatewayDeleteProducer.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this GatewayDeleteProducer.

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :param token: The token of this GatewayDeleteProducer.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid_token(self):
        """Gets the uid_token of this GatewayDeleteProducer.  # noqa: E501

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :return: The uid_token of this GatewayDeleteProducer.  # noqa: E501
        :rtype: str
        """
    ...
    def uid_token(self, uid_token):
        """Sets the uid_token of this GatewayDeleteProducer.

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :param uid_token: The uid_token of this GatewayDeleteProducer.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GatewayDeleteProducer):
            return False
