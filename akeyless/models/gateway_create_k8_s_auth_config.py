...
class GatewayCreateK8SAuthConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access-id", "cluster-api-type", "disable-issuer-validation", "json", "k8s-auth-type", "k8s-ca-cert", "k8s-client-certificate", "k8s-client-key", "k8s-host", "k8s-issuer", "name", "rancher-api-key", "rancher-cluster-id", "signing-key", "token", "token-exp", "token-reviewer-jwt", "uid-token", "use-gw-service-account"]
