...
class CustomerFragmentsConfigJson(BaseModel):
    """
    CustomerFragmentsConfigJson
    """ # noqa: E501
    customer_fragments: Optional[List[CustomerFragmentConfig]] = None
    __properties: ClassVar[List[str]] = ["customer_fragments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer_fragments": [CustomerFragmentConfig.from_dict(_item) for _item in obj["customer_fragments"]] if obj.get("customer_fragments") is not None else None
        })
        return _obj
