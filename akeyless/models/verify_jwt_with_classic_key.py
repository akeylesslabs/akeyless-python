...
class VerifyJWTWithClassicKey(BaseModel):
    """
    VerifyJWTWithClassicKey
    """ # noqa: E501
    display_id: StrictStr = Field(description="The name of the key to use in the verify JWT process", alias="display-id")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    jwt: StrictStr = Field(description="JWT")
    required_claims: StrictStr = Field(description="RequiredClaims", alias="required-claims")
    ...
    __properties: ClassVar[List[str]] = ["display-id", "json", "jwt", "required-claims", "token", "uid-token", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jwt": obj.get("jwt"),
            "required-claims": obj.get("required-claims"),
            "token": obj.get("token"),
