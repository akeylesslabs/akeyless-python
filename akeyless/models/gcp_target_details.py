...
class GcpTargetDetails(BaseModel):
    """
    GcpTargetDetails
    """ # noqa: E501
    gcp_service_account_email: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["gcp_service_account_email", "gcp_service_account_key", "gcp_service_account_key_base64", "gcp_service_account_key_id", "use_gw_cloud_identity"]
