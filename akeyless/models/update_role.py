...
class UpdateRole(object):
    ...
    def __init__(self, analytics_access=None, approve_access_request=None, ara_reports_access=None, audit_access=None, delete_protection=None, description='default_comment', event_center_access=None, event_forwarder_access=None, gw_analytics_access=None, isi_access=None, json=False, name=None, new_comment='default_comment', new_name=None, reverse_rbac_access=None, sra_reports_access=None, token=None, uid_token=None, unlock_secrets=None, usage_reports_access=None, local_vars_configuration=None):  # noqa: E501
    ...
    def approve_access_request(self):
        """Gets the approve_access_request of this UpdateRole.  # noqa: E501
        ...
        :return: The approve_access_request of this UpdateRole.  # noqa: E501
        :rtype: str
        """
    ...
    def approve_access_request(self, approve_access_request):
        """Sets the approve_access_request of this UpdateRole.

        Allow this role to approve Access Requests for items. Currently only 'none', 'scoped' and 'all' values are supported. The tier controls how broadly the approver may list Auth Methods; neither tier lets them grant permissions they do not already hold on the requested item or target.  # noqa: E501

        :param approve_access_request: The approve_access_request of this UpdateRole.  # noqa: E501
        :type: str
        """
    ...
    def unlock_secrets(self, unlock_secrets):
        """Sets the unlock_secrets of this UpdateRole.

        Allow this role to force-unlock locked secrets. Currently only 'none', 'scoped' and 'all' values are supported.  # noqa: E501

        :param unlock_secrets: The unlock_secrets of this UpdateRole.  # noqa: E501
        :type: str
        """
