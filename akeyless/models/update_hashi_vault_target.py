...
class UpdateHashiVaultTarget(BaseModel):
    """
    ...
    hashi_url: Optional[StrictStr] = Field(default=None, description="HashiCorp Vault API URL, e.g. https://vault-mgr01:8200", alias="hashi-url")
    ...
    namespace: Optional[List[StrictStr]] = Field(default=None, description="Comma-separated list of vault namespaces")
    ...
    vault_token: Optional[StrictStr] = Field(default=None, description="Vault access token with sufficient permissions", alias="vault-token")
    __properties: ClassVar[List[str]] = ["description", "hashi-url", "json", "keep-prev-version", "key", "max-versions", "name", "namespace", "new-name", "token", "uid-token", "update-version", "vault-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vault-token": obj.get("vault-token")
        })
        return _obj
