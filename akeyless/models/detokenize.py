...
class Detokenize(BaseModel):
    ...
    """ # noqa: E501
    ciphertext: StrictStr = Field(description="Data to be decrypted")
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    token: Optional[StrictStr] = Field(default=None, description="Authentication token (see `/auth` and `/configure`)")
    tokenizer_name: StrictStr = Field(description="The name of the tokenizer to use in the decryption process", alias="tokenizer-name")
    ...
    __properties: ClassVar[List[str]] = ["ciphertext", "json", "token", "tokenizer-name", "tweak", "uid-token"]
