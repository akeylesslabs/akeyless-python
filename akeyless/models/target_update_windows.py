...
class TargetUpdateWindows(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["certificate", "connection-type", "description", "domain", "hostname", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "parent-target-name", "password", "port", "token", "uid-token", "use-tls", "username"]
