...
class TargetUpdateWindows(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certificate", "description", "domain", "hostname", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "port", "token", "uid-token", "use-tls", "username"]
