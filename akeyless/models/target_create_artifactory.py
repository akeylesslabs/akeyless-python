...
class TargetCreateArtifactory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["artifactory-admin-name", "artifactory-admin-pwd", "base-url", "description", "json", "key", "max-versions", "name", "token", "uid-token"]
