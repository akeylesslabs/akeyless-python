...
class ProvisionCertificateOutput(BaseModel):
    """
    ProvisionCertificateOutput
    """ # noqa: E501
    fail_message: Optional[StrictStr] = Field(default=None, alias="FailMessage")
    success_message: Optional[StrictStr] = Field(default=None, alias="SuccessMessage")
    host_names: Optional[List[StrictStr]] = None
    provisioned_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["FailMessage", "SuccessMessage", "host_names", "provisioned_at"]
