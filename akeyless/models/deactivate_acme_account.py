...
class DeactivateAcmeAccount(BaseModel):
    """
    deactivateAcmeAccount is a command that Deactivates \\ Deletes an acme external account
    """ # noqa: E501
    acme_account_id: StrictStr = Field(description="The acme account id to deactivate", alias="acme-account-id")
    cert_issuer_name: StrictStr = Field(description="The name of the PKI certificate issuer", alias="cert-issuer-name")
    delete_account: Optional[StrictBool] = Field(default=None, description="Delete the account", alias="delete-account")
    ...
    __properties: ClassVar[List[str]] = ["acme-account-id", "cert-issuer-name", "delete-account", "json", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acme-account-id": obj.get("acme-account-id"),
            "cert-issuer-name": obj.get("cert-issuer-name"),
            "delete-account": obj.get("delete-account"),
