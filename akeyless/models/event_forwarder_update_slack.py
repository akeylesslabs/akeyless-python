...
class EventForwarderUpdateSlack(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auth-methods-event-source-locations", "description", "enable", "event-types", "gateways-event-source-locations", "items-event-source-locations", "json", "keep-prev-version", "key", "name", "new-name", "targets-event-source-locations", "token", "uid-token", "url"]
