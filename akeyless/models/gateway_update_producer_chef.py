...
class GatewayUpdateProducerChef(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chef-orgs", "chef-server-key", "chef-server-url", "chef-server-username", "delete_protection", "json", "name", "new-name", "password-length", "producer-encryption-key-name", "skip-ssl", "tags", "target-name", "token", "uid-token", "user-ttl"]
