...
class ReverseRBAC(object):
    ...
    @property
    def path(self):
        """Gets the path of this ReverseRBAC.  # noqa: E501

        Path to an object  # noqa: E501

        :return: The path of this ReverseRBAC.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this ReverseRBAC.

        Path to an object  # noqa: E501

        :param path: The path of this ReverseRBAC.  # noqa: E501
        :type: str
        """
    ...
    @property
    def token(self):
        """Gets the token of this ReverseRBAC.  # noqa: E501

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :return: The token of this ReverseRBAC.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this ReverseRBAC.

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :param token: The token of this ReverseRBAC.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid_token(self):
        """Gets the uid_token of this ReverseRBAC.  # noqa: E501

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :return: The uid_token of this ReverseRBAC.  # noqa: E501
        :rtype: str
        """
    ...
    def uid_token(self, uid_token):
        """Sets the uid_token of this ReverseRBAC.

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :param uid_token: The uid_token of this ReverseRBAC.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReverseRBAC):
            return False
