...
class BastionsList(BaseModel):
    """
    BastionsList
    """ # noqa: E501
    clusters: Optional[List[BastionListEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [BastionListEntry.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
