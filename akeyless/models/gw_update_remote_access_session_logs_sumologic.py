...
class GwUpdateRemoteAccessSessionLogsSumologic(BaseModel):
    """
    ...
    endpoint: Optional[StrictStr] = Field(default=None, description="Sumologic endpoint URL")
    host: Optional[StrictStr] = Field(default='use-existing', description="Sumologic host")
    ...
    sumologic_tags: Optional[StrictStr] = Field(default='use-existing', description="A comma-separated list of Sumologic tags", alias="sumologic-tags")
    ...
    __properties: ClassVar[List[str]] = ["enable", "endpoint", "host", "json", "output-format", "pull-interval", "sumologic-tags", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "host": obj.get("host") if obj.get("host") is not None else 'use-existing',
            ...
            "sumologic-tags": obj.get("sumologic-tags") if obj.get("sumologic-tags") is not None else 'use-existing',
            "token": obj.get("token"),
