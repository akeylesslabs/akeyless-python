...
class DynamicSecretCreateRedis(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["acl-rules", "delete_protection", "description", "host", "json", "name", "password", "password-length", "port", "producer-encryption-key-name", "ssl", "ssl-certificate", "tags", "target-name", "token", "uid-token", "user-ttl", "username"]
