...
class GetRotatedSecretValue(BaseModel):
    """
    GetRotatedSecretValue
    """ # noqa: E501
    host: Optional[StrictStr] = Field(default=None, description="Get rotated secret value of specific Host (relevant only for Linked Target)")
    ...
    names: StrictStr = Field(description="Secret name")
    ...
    version: Optional[StrictInt] = Field(default=None, description="Secret version")
    __properties: ClassVar[List[str]] = ["host", "ignore-cache", "json", "names", "token", "uid-token", "version"]
