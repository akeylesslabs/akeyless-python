...
class GatewayUpdateK8SAuthConfig(object):
    ...
    def k8s_auth_type(self):
        """Gets the k8s_auth_type of this GatewayUpdateK8SAuthConfig.  # noqa: E501

        K8S auth type [token/certificate]. (relevant for \"native_k8s\" only)  # noqa: E501

        :return: The k8s_auth_type of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def k8s_auth_type(self, k8s_auth_type):
        """Sets the k8s_auth_type of this GatewayUpdateK8SAuthConfig.

        K8S auth type [token/certificate]. (relevant for \"native_k8s\" only)  # noqa: E501

        :param k8s_auth_type: The k8s_auth_type of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :type: str
        """
    ...
    def k8s_client_certificate(self):
        """Gets the k8s_client_certificate of this GatewayUpdateK8SAuthConfig.  # noqa: E501

        Content of the k8 client certificate (PEM format) in a Base64 format (relevant for \"native_k8s\" only)  # noqa: E501

        :return: The k8s_client_certificate of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def k8s_client_certificate(self, k8s_client_certificate):
        """Sets the k8s_client_certificate of this GatewayUpdateK8SAuthConfig.

        Content of the k8 client certificate (PEM format) in a Base64 format (relevant for \"native_k8s\" only)  # noqa: E501

        :param k8s_client_certificate: The k8s_client_certificate of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :type: str
        """
    ...
    def k8s_client_key(self):
        """Gets the k8s_client_key of this GatewayUpdateK8SAuthConfig.  # noqa: E501

        Content of the k8 client private key (PEM format) in a Base64 format (relevant for \"native_k8s\" only)  # noqa: E501

        :return: The k8s_client_key of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def k8s_client_key(self, k8s_client_key):
        """Sets the k8s_client_key of this GatewayUpdateK8SAuthConfig.

        Content of the k8 client private key (PEM format) in a Base64 format (relevant for \"native_k8s\" only)  # noqa: E501

        :param k8s_client_key: The k8s_client_key of this GatewayUpdateK8SAuthConfig.  # noqa: E501
        :type: str
        """
