...
class TargetDelete(BaseModel):
    ...
    """ # noqa: E501
    force_deletion: Optional[StrictBool] = Field(default=False, description="Enforce deletion", alias="force-deletion")
    ...
    __properties: ClassVar[List[str]] = ["force-deletion", "json", "name", "target-version", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "force-deletion": obj.get("force-deletion") if obj.get("force-deletion") is not None else False,
