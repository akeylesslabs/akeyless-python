...
class TargetUpdateAws(BaseModel):
    """
    TargetUpdateAws
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["access-key", "access-key-id", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "region", "session-token", "token", "uid-token", "use-gw-cloud-identity"]
