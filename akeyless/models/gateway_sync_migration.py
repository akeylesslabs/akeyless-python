...
class GatewaySyncMigration(BaseModel):
    """
    gatewaySyncMigration is a command that sync migration
    """ # noqa: E501
    var_json: Optional[StrictBool] = Field(default=False, description="Set output format to JSON", alias="json")
    name: StrictStr = Field(description="Migration name")
    start_sync: Optional[StrictBool] = Field(default=None, description="true, for starting synchronization, false for stopping", alias="start-sync")
    ...
    __properties: ClassVar[List[str]] = ["json", "name", "start-sync", "token", "uid-token"]
