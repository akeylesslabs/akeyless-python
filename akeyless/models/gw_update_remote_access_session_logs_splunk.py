...
class GwUpdateRemoteAccessSessionLogsSplunk(BaseModel):
    """
    ...
    index: Optional[StrictStr] = Field(default=None, description="Splunk index")
    ...
    source: Optional[StrictStr] = Field(default='use-existing', description="Splunk source")
    source_type: Optional[StrictStr] = Field(default='use-existing', description="Splunk source type", alias="source-type")
    splunk_token: Optional[StrictStr] = Field(default=None, description="Splunk token", alias="splunk-token")
    splunk_url: Optional[StrictStr] = Field(default=None, description="Splunk server URL", alias="splunk-url")
    tls_certificate: Optional[StrictStr] = Field(default='use-existing', description="Splunk tls certificate", alias="tls-certificate")
    ...
    __properties: ClassVar[List[str]] = ["enable", "enable-tls", "index", "json", "output-format", "pull-interval", "source", "source-type", "splunk-token", "splunk-url", "tls-certificate", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": obj.get("source") if obj.get("source") is not None else 'use-existing',
            "source-type": obj.get("source-type") if obj.get("source-type") is not None else 'use-existing',
            "splunk-token": obj.get("splunk-token"),
            "splunk-url": obj.get("splunk-url"),
