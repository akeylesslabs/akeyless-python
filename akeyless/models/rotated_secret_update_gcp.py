...
class RotatedSecretUpdateGcp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["add-tag", "authentication-credentials", "auto-rotate", "delete_protection", "description", "gcp-key", "gcp-service-account-email", "gcp-service-account-key-id", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password-length", "rm-tag", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "token", "uid-token"]
