...
class RotatedSecretSync(object):
    ...
    def filter_secret_value(self):
        """Gets the filter_secret_value of this RotatedSecretSync.  # noqa: E501

        JQ expression to filter or transform the secret value  # noqa: E501

        :return: The filter_secret_value of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def filter_secret_value(self, filter_secret_value):
        """Sets the filter_secret_value of this RotatedSecretSync.

        JQ expression to filter or transform the secret value  # noqa: E501

        :param filter_secret_value: The filter_secret_value of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    def gcp_project_id(self):
        """Gets the gcp_project_id of this RotatedSecretSync.  # noqa: E501

        GCP project to sync the secret to. Relevant only for GCP USCs; must be a project available on the USC  # noqa: E501

        :return: The gcp_project_id of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def gcp_project_id(self, gcp_project_id):
        """Sets the gcp_project_id of this RotatedSecretSync.

        GCP project to sync the secret to. Relevant only for GCP USCs; must be a project available on the USC  # noqa: E501

        :param gcp_project_id: The gcp_project_id of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    @property
    def json(self):
        """Gets the json of this RotatedSecretSync.  # noqa: E501

        Set output format to JSON  # noqa: E501

        :return: The json of this RotatedSecretSync.  # noqa: E501
        :rtype: bool
        """
        return self._json
    ...
    @json.setter
    def json(self, json):
        """Sets the json of this RotatedSecretSync.

        Set output format to JSON  # noqa: E501

        :param json: The json of this RotatedSecretSync.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this RotatedSecretSync.  # noqa: E501

        Rotated secret name  # noqa: E501

        :return: The name of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RotatedSecretSync.

        Rotated secret name  # noqa: E501

        :param name: The name of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this RotatedSecretSync.  # noqa: E501

        Vault namespace, releavnt only for Hashicorp Vault Target  # noqa: E501

        :return: The namespace of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this RotatedSecretSync.

        Vault namespace, releavnt only for Hashicorp Vault Target  # noqa: E501

        :param namespace: The namespace of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    def remote_secret_name(self):
        """Gets the remote_secret_name of this RotatedSecretSync.  # noqa: E501

        Remote Secret Name that will be synced on the remote endpoint  # noqa: E501

        :return: The remote_secret_name of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def remote_secret_name(self, remote_secret_name):
        """Sets the remote_secret_name of this RotatedSecretSync.

        Remote Secret Name that will be synced on the remote endpoint  # noqa: E501

        :param remote_secret_name: The remote_secret_name of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    @property
    def token(self):
        """Gets the token of this RotatedSecretSync.  # noqa: E501

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :return: The token of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this RotatedSecretSync.

        Authentication token (see `/auth` and `/configure`)  # noqa: E501

        :param token: The token of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid_token(self):
        """Gets the uid_token of this RotatedSecretSync.  # noqa: E501

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :return: The uid_token of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def uid_token(self, uid_token):
        """Sets the uid_token of this RotatedSecretSync.

        The universal identity token, Required only for universal_identity authentication  # noqa: E501

        :param uid_token: The uid_token of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    @property
    def usc_name(self):
        """Gets the usc_name of this RotatedSecretSync.  # noqa: E501

        Universal Secret Connector name, If not provided all attached USC's will be synced  # noqa: E501

        :return: The usc_name of this RotatedSecretSync.  # noqa: E501
        :rtype: str
        """
    ...
    def usc_name(self, usc_name):
        """Sets the usc_name of this RotatedSecretSync.

        Universal Secret Connector name, If not provided all attached USC's will be synced  # noqa: E501

        :param usc_name: The usc_name of this RotatedSecretSync.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RotatedSecretSync):
            return False
