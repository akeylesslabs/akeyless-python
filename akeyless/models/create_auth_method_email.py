...
class CreateAuthMethodEmail(BaseModel):
    """
    ...
    email: StrictStr = Field(description="An email address to be invited to have access")
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "audit-logs-claims", "bound-ips", "delete_protection", "description", "email", "enable-mfa", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "mfa-type", "name", "product-type", "token", "uid-token"]
