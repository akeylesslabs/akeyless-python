...
class KerberosAuthMethodInfo(BaseModel):
    """
    KerberosAuthMethodInfo
    """ # noqa: E501
    kerberos_keytab: Optional[StrictStr] = None
    kerberos_krb5_conf: Optional[StrictStr] = None
    ...
    ldap_url_address: Optional[StrictStr] = None
    ldap_user_attr: Optional[StrictStr] = None
    ldap_user_dn: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["kerberos_keytab", "kerberos_krb5_conf", "ldap_anonymous_search", "ldap_bind_dn", "ldap_bind_password", "ldap_certificate", "ldap_group_attr", "ldap_group_dn", "ldap_group_filter", "ldap_url_address", "ldap_user_attr", "ldap_user_dn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kerberos_krb5_conf": obj.get("kerberos_krb5_conf"),
            ...
            "ldap_url_address": obj.get("ldap_url_address"),
