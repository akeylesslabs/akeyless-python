...
class AzureTargetDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["azure_client_id", "azure_client_secret", "azure_resource_group_name", "azure_resource_name", "azure_subscription_id", "azure_tenant_id", "azure_username", "expiration_date", "use_gw_cloud_identity"]
