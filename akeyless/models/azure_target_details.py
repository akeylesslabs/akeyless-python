...
class AzureTargetDetails(object):
    ...
    def __init__(self, azure_client_id=None, azure_client_secret=None, azure_resource_group_name=None, azure_resource_name=None, azure_subscription_id=None, azure_tenant_id=None, azure_username=None, connection_type=None, expiration_date=None, use_gw_cloud_identity=None, local_vars_configuration=None):  # noqa: E501
