...
class GatewayUpdateProducerPing(BaseModel):
    """
    ...
    new_name: Optional[StrictStr] = Field(default=None, description="Dynamic secret New name", alias="new-name")
