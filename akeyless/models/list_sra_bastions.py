...
class ListSRABastions(BaseModel):
    """
    ListSRABastions
    """ # noqa: E501
    allowed_urls_only: Optional[StrictBool] = Field(default=False, description="Filter the response to show only bastions allowed URLs", alias="allowed-urls-only")
    ...
    __properties: ClassVar[List[str]] = ["allowed-urls-only", "json", "token", "uid-token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowed-urls-only": obj.get("allowed-urls-only") if obj.get("allowed-urls-only") is not None else False,
