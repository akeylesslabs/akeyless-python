...
class GatewayPartialUpdateK8SAuthConfig(BaseModel):
    """
    GatewayPartialUpdateK8SAuthConfig
    """ # noqa: E501
    use_default_identity_bool: Optional[StrictBool] = Field(default=None, alias="UseDefaultIdentityBool")
    access_id: Optional[StrictStr] = Field(default=None, description="The access ID of the Kubernetes auth method", alias="access-id")
    ...
    k8s_host: Optional[StrictStr] = Field(default=None, description="The URL of the kubernetes API server", alias="k8s-host")
    k8s_issuer: Optional[StrictStr] = Field(default=None, description="The Kubernetes JWT issuer name. K8SIssuer is the claim that specifies who issued the Kubernetes token", alias="k8s-issuer")
    name: Optional[StrictStr] = Field(default=None, description="K8S Auth config name")
    new_name: Optional[StrictStr] = Field(default=None, description="K8S Auth config new name", alias="new-name")
    ...
    signing_key: Optional[StrictStr] = Field(default=None, description="The private key (base64 encoded) associated with the public key defined in the Kubernetes auth", alias="signing-key")
    token: Optional[StrictStr] = Field(default=None, description="Authentication token (see `/auth` and `/configure`)")
    token_exp: Optional[StrictInt] = Field(default=None, description="Time in seconds of expiration of the Akeyless Kube Auth Method token", alias="token-exp")
    ...
    use_gw_service_account: Optional[StrictStr] = Field(default=None, description="Use the GW's service account", alias="use-gw-service-account")
    __properties: ClassVar[List[str]] = ["UseDefaultIdentityBool", "access-id", "disable-issuer-validation", "json", "k8s-auth-type", "k8s-ca-cert", "k8s-client-certificate", "k8s-client-key", "k8s-host", "k8s-issuer", "name", "new-name", "rancher-api-key", "rancher-cluster-id", "signing-key", "token", "token-exp", "token-reviewer-jwt", "uid-token", "use-gw-service-account"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UseDefaultIdentityBool": obj.get("UseDefaultIdentityBool"),
