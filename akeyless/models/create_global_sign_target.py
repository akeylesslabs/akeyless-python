...
class CreateGlobalSignTarget(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "contact-email", "contact-first-name", "contact-last-name", "contact-phone", "description", "json", "key", "max-versions", "name", "password", "profile-id", "timeout", "token", "uid-token", "username"]
