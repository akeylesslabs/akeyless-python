...
class AuthMethodCreateSAML(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access-expires", "allowed-redirect-uri", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "idp-metadata-url", "idp-metadata-xml-data", "json", "jwt-ttl", "name", "product-type", "subclaims-delimiters", "token", "uid-token", "unique-identifier"]
