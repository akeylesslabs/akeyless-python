...
class RotatedSecretDelete(BaseModel):
    """
    ...
    version: Optional[StrictInt] = Field(default=-1, description="The specific version you want to delete, -1=entire item with all versions (default)")
    __properties: ClassVar[List[str]] = ["json", "name", "token", "uid-token", "version"]
