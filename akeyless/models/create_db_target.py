...
class CreateDBTarget(BaseModel):
    """
    ...
    connection_type: StrictStr = Field(description="Type of connection to mssql database [credentials/cloud-identity/wallet/parent-target]", alias="connection-type")
    ...
    __properties: ClassVar[List[str]] = ["azure-client-id", "azure-client-secret", "azure-tenant-id", "cloud-service-provider", "cluster-mode", "comment", "connection-type", "db-name", "db-server-certificates", "db-server-name", "db-type", "description", "host", "json", "key", "max-versions", "mongodb-atlas", "mongodb-atlas-api-private-key", "mongodb-atlas-api-public-key", "mongodb-atlas-project-id", "mongodb-default-auth-db", "mongodb-uri-options", "name", "oracle-service-name", "oracle-wallet-login-type", "oracle-wallet-p12-file-data", "oracle-wallet-sso-file-data", "parent-target-name", "port", "pwd", "snowflake-account", "snowflake-api-private-key", "snowflake-api-private-key-password", "ssl", "ssl-certificate", "token", "uid-token", "user-name"]
