...
class CreateAuthMethodUniversalIdentity(object):
    ...
    def allowed_client_type(self):
        """Gets the allowed_client_type of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        limit the auth method usage for specific client types [cli,ui,gateway-admin,sdk,mobile,extension]  # noqa: E501

        :return: The allowed_client_type of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_client_type(self, allowed_client_type):
        """Sets the allowed_client_type of this CreateAuthMethodUniversalIdentity.

        limit the auth method usage for specific client types [cli,ui,gateway-admin,sdk,mobile,extension]  # noqa: E501

        :param allowed_client_type: The allowed_client_type of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: list[str]
        """
    ...
    def audit_logs_claims(self):
        """Gets the audit_logs_claims of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        Subclaims to include in audit logs, e.g \"--audit-logs-claims email --audit-logs-claims username\"  # noqa: E501

        :return: The audit_logs_claims of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def audit_logs_claims(self, audit_logs_claims):
        """Sets the audit_logs_claims of this CreateAuthMethodUniversalIdentity.

        Subclaims to include in audit logs, e.g \"--audit-logs-claims email --audit-logs-claims username\"  # noqa: E501

        :param audit_logs_claims: The audit_logs_claims of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: list[str]
        """
    ...
    def child_ttl_limit(self):
        """Gets the child_ttl_limit of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        Maximum child token ttl allowed in uid-create-child-token  # noqa: E501

        :return: The child_ttl_limit of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: int
        """
    ...
    def child_ttl_limit(self, child_ttl_limit):
        """Sets the child_ttl_limit of this CreateAuthMethodUniversalIdentity.

        Maximum child token ttl allowed in uid-create-child-token  # noqa: E501

        :param child_ttl_limit: The child_ttl_limit of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: int
        """
    ...
    def delete_protection(self):
        """Gets the delete_protection of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        Protection from accidental deletion of this object [true/false]  # noqa: E501

        :return: The delete_protection of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: str
        """
    ...
    def delete_protection(self, delete_protection):
        """Sets the delete_protection of this CreateAuthMethodUniversalIdentity.

        Protection from accidental deletion of this object [true/false]  # noqa: E501

        :param delete_protection: The delete_protection of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: str
        """
    ...
    def expiration_event_in(self):
        """Gets the expiration_event_in of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        How many days before the expiration of the auth method would you like to be notified.  # noqa: E501

        :return: The expiration_event_in of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def expiration_event_in(self, expiration_event_in):
        """Sets the expiration_event_in of this CreateAuthMethodUniversalIdentity.

        How many days before the expiration of the auth method would you like to be notified.  # noqa: E501

        :param expiration_event_in: The expiration_event_in of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: list[str]
        """
    ...
    def tree_length(self):
        """Gets the tree_length of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        Maximum UID tree depth allowed (child of child of ...)  # noqa: E501

        :return: The tree_length of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: int
        """
    ...
    def tree_length(self, tree_length):
        """Sets the tree_length of this CreateAuthMethodUniversalIdentity.

        Maximum UID tree depth allowed (child of child of ...)  # noqa: E501

        :param tree_length: The tree_length of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: int
        """
    ...
    def uid_expiration_event_at(self):
        """Gets the uid_expiration_event_at of this CreateAuthMethodUniversalIdentity.  # noqa: E501

        Notify when this percent of the token TTL has elapsed (1-99).  # noqa: E501

        :return: The uid_expiration_event_at of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def uid_expiration_event_at(self, uid_expiration_event_at):
        """Sets the uid_expiration_event_at of this CreateAuthMethodUniversalIdentity.

        Notify when this percent of the token TTL has elapsed (1-99).  # noqa: E501

        :param uid_expiration_event_at: The uid_expiration_event_at of this CreateAuthMethodUniversalIdentity.  # noqa: E501
        :type: list[str]
        """
